          ...
          t.exports = {
            ...
            get: function (e) {
              for (
                ...
                if (0 === i.indexOf(t))
                  return this.decodeData(i.substring(t.length, i.length));
              }
              return null;
            },
            ...
            parse: function (e) {
              ...
              for (var a = 0; a < t.length; a++) {
                var s;
                (r[this.unsbjs(t[a])] = {}),
                  (s = this.get(t[a]) ? this.get(t[a]).split(n) : []);
                for (var o = 0; o < s.length; o++) {
                  var c = s[o].split("="),
                    u = c.splice(0, 1);
                  u.push(c.join("=")),
                    (r[this.unsbjs(t[a])][u[0]] = this.decodeData(u[1]));
                }
              }
              return r;
            },
          ...
          t.exports = function (e) {
            ...
            function w(e) {
              switch (e) {
                ...
                case i.traffic.typein:
                  (t = i.traffic.typein),
                    (r = _.typein_attributes.source),
                    (p = _.typein_attributes.medium),
                    (f = i.none),
                    (m = i.none),
                    (d = i.none),
                    (l = i.none);
                        ...
                        if (
                          s
                            ...
                            .host.match(
                              new RegExp(
                                "^(?:.*\\.)?" +
                                  o.escapeRegexp(_.organics[a].host) +
                                  "$",
                                "i"
                              )
                            ) &&
                          s
                            ...
                            .query.match(
                              new RegExp(
                                ".*" +
                                  o.escapeRegexp(_.organics[a].param) +
                                  "=.*",
                                "i"
                              )
                            )
                          ...
                          return (
                            (r = _.organics[a].display || _.organics[a].host),
                            !0
                          );
                        ...
                        if (
                          s
                            ...
                            .host.match(
                              new RegExp(
                                "^(?:.*\\.)?" +
                                  o.escapeRegexp(_.referrals[t].host) +
                                  "$",
                                "i"
                              )
                            )
                          ...
                          return (
                            (r = _.referrals[t].display || _.referrals[t].host),
                            (p = _.referrals[t].medium || i.referer.referral),
                            !0
                          );
                        if (t + 1 === _.referrals.length)
                          return (r = s.getHost(e)), !0;
                      }
                    })(t)
                  );
            ...
            function j() {
              a.set(
                ...
                n.pack.extra(_.timezone_offset),
                k,
                x,
                b
              ),
                a.get(n.containers.first_extra) ||
                  a.set(
            ...
            return (
              ...
              a.set(
                ...
                (function () {
                  ...
                  if (
                    ...
                    j(), (e = w(i.traffic.utm));
                  else if (q(i.traffic.organic))
                    j(), (e = w(i.traffic.organic));
                  else if (
                    !a.get(n.containers.session) &&
                    q(i.traffic.referral)
                  )
                    j(), (e = w(i.traffic.referral));
                  else {
                    if (
                      a.get(n.containers.first) ||
                      a.get(n.containers.current)
                    )
                      return a.get(n.containers.current);
              ...
              a.get(n.containers.first) ||
                a.set(n.containers.first, a.get(n.containers.current), k, x, b),
              a.get(n.containers.udata)
                ? ((g =
                    parseInt(
                      a.parse(n.containers.udata)[a.unsbjs(n.containers.udata)][
                        n.aliases.udata.visits
                      ]
                    ) || 1),
                  (g = a.get(n.containers.session) ? g : g + 1),
                  (h = n.pack.user(g, _.user_ip)))
                : ((g = 1), (h = n.pack.user(g, _.user_ip))),
              a.set(n.containers.udata, h, k, x, b),
              a.get(n.containers.session)
                ? ((y =
                    parseInt(
                      a.parse(n.containers.session)[
                        a.unsbjs(n.containers.session)
              ...
              _.promocode &&
                !a.get(n.containers.promocode) &&
                a.set(
                  n.containers.promocode,
                  n.pack.promo(_.promocode),
                  k,
                  x,
                  b
                ),
            ...
            go: function (e, t, r) {
              ...
              if (i.get(n.containers.first) || i.get(n.service.migrations)) {
                ...
                for (a = 0; a < c.length; a++)
                  (u += c[a] + "=1"), a < c.length - 1 && (u += n.delimiter);
                  ...
                  try {
                    ...
                    for (var u = 0; u < o.length; u++)
                      if (i.get(o[u])) {
                        ...
                        i.destroy(o[u], t.d, t.i),
                          i.destroy(o[u], t.d, !t.i),
                          i.set(o[u], p, t.l, t.d, t.i);
                      }
                    i.get(n.containers.session) &&
                      ...
                      i.set(n.service.migrations, r, t.l, t.d, t.i);
                  } catch (f) {
          ...
          t.exports = {
            fetch: function (e) {
              ...
              if (
                ...
                for (var a = 0; a < t.referrals.length; a++)
                  t.referrals[a].host && r.referrals.push(t.referrals[a]);
