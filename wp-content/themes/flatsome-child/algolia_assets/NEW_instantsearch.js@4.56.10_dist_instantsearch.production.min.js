...
!(function (e, t) {
  ...
  function de(e) {
    ...
    return 1 === l.length && "object" === y(l[0])
      ...
      : ((t = j(l[0].split(":"), 2)),
        ...
        0 === (l = Array.isArray(t) ? t : [t]).length
          ? []
          : ((a = l[0].__queryID),
            (t = (function (e, t) {
              for (
  ...
  function _e(e) {
    ...
    (r = e),
      (a = (i = j(r.split(",").map(parseFloat), 4))[0]),
      (n = i[1]),
      (t = i[2]),
      (i = i[3]);
    if (a && n && t && i)
  ...
  function ke(e, t) {
    if (e === t) return 1;
    if (Ee(e) || Ee(t) || "function" == typeof e || "function" == typeof t)
      return e === t;
  ...
  var Me = [
    ...
    Be = function (e, t) {
      return e.setQueryParameters({
        facetsRefinements: C(C({}, e.facetsRefinements), t.facetsRefinements),
      });
    },
    Ue = function (e, t) {
      return e.setQueryParameters({
        facetsExcludes: C(C({}, e.facetsExcludes), t.facetsExcludes),
      });
    },
    $e = function (e, t) {
      return e.setQueryParameters({
        disjunctiveFacetsRefinements: C(
          C({}, e.disjunctiveFacetsRefinements),
          t.disjunctiveFacetsRefinements
        ),
      });
    },
    qe = function (e, t) {
      return e.setQueryParameters({
        numericRefinements: C(
          C({}, e.numericRefinements),
          t.numericRefinements
        ),
      });
    },
    Qe = function (e, t) {
      return e.setQueryParameters({
        hierarchicalFacetsRefinements: C(
          C({}, e.hierarchicalFacetsRefinements),
          t.hierarchicalFacetsRefinements
        ),
      });
    },
    Ve = function (e, t) {
      t = Le([].concat(e.ruleContexts).concat(t.ruleContexts).filter(Boolean));
  ...
  function tt(y) {
    ...
    return (
      ...
      function (e) {
            ...
            (c = ge(y, (a = void 0) === h ? 100 : h)),
            {
              ...
              init: function (e) {
                ...
                if ("function" != typeof t.findAnswers)
                  throw new Error(it("`algoliasearch` >= 4.8.0 required."));
                (u = ge(t.findAnswers, p)),
                  y(
                    C(
                      C({}, this.getWidgetRenderState(e)),
                      {},
        ...
        throw new Error(
          it("The `queryLanguages` expects an array of strings.")
        );
      }
    );
  }
    ...
    return (
      ...
      function (n) {
        ...
        if (
          ...
          throw new Error(
            at("The `widgets` option expects an array of widgets.")
          );
        if (
          Array.isArray(i) &&
          i.length <= 1 &&
  ...
  function ut(e) {
    var t = e.results,
      ...
      o = Ie(t, n.state, e).map(ht).filter(s);
    ...
    return (
      ...
      function (u) {
        ...
        if (!l || !Array.isArray(l) || 0 === l.length)
          throw new Error(
            gt("The `attributes` option expects an array of strings.")
          );
        if (!0 === h && s <= a)
          throw new Error(
            gt("The `showMoreLimit` option must be greater than `limit`.")
          );
        var p,
          g,
          v = j(l, 1)[0],
        ...
        return {
          ...
          render: function (e) {
            ...
            (t = e),
              ...
              c(
                C(
                  C({}, (n = this).getWidgetRenderState(e)),
                  {},
                  { instantSearchInstance: r }
                ),
                !1
  ...
  function L(e, t, n) {
    ...
    if (
      (2 < arguments.length &&
        (s.children = 3 < arguments.length ? St.call(arguments, 2) : n),
  ...
  function Mt(e) {
    ((e.__d || ((e.__d = !0), !wt.push(e)) || Ot.__r++) &&
      Pt === N.debounceRendering) ||
  ...
  function Wt(e, t, n) {
    "-" === t[0]
      ? e.setProperty(t, n)
      : (e[t] =
          null == n ? "" : "number" != typeof n || It.test(t) ? n : n + "px");
  }
  function Dt(e, t, n, r, i) {
    ...
    e: if ("style" === t)
      ...
      (a = t !== (t = t.replace(/Capture$/, ""))),
        ...
        e.l || (e.l = {}),
        (e.l[t + a] = n)
          ? r || e.addEventListener(t, a ? Ut : Bt, a)
          : e.removeEventListener(t, a ? Ut : Bt, a);
        ...
        e: if ("function" == typeof _) {
          if (
            ...
            null != _.getDerivedStateFromProps &&
              (l.__s == l.state && (l.__s = Ft({}, l.__s)),
              Ft(l.__s, _.getDerivedStateFromProps(g, l.__s))),
            (h = l.props),
            (f = l.state),
            d)
          )
  ...
  function Zt(r) {
    ...
    return (
      ...
      function (s) {
        ...
        if (!Array.isArray(t))
          throw new Error(
            Xt("The `items` option expects an array of objects.")
          );
        var c = t,
        ...
        if (0 === e.length)
          throw new Error(Xt("A default value must be specified in `items`."));
        if (1 < e.length)
          throw new Error(
            Xt("More than one default value is specified in `items`.")
          );
        var n = e[0],
          u = function (t) {
            return function (e) {
      ...
      function (f) {
        ...
        return {
          ...
          render: function (e) {
            ...
            i(C(C({}, e), {}, { instantSearchInstance: t }), !1),
              g("view:internal", e.currentPageHits);
          },
          getRenderState: function (e, t) {
            return C(
              C({}, e),
                ...
                : ((m = function () {
                    r.overrideStateWithoutTriggeringChangeEvent(
                      C(
                        ...
                        {
                          page:
                            S(r.state, R.read({ state: rn(r.state) }) || {}) -
                            1,
                        }
                      )
                  ...
                  (p = function () {
                    n.setPage(
                      _(n.state, R.read({ state: rn(n.state) }) || {}) + 1
                    ).search();
                  }),
                  (g = he({
                    instantSearchInstance: e,
                    index: (n = r = s).getIndex(),
                    widgetType: this.$$type,
                  })),
                  (v = fe({
                    index: s.getIndex(),
          ...
          getWidgetSearchParameters: function (e, t) {
            var t = t.uiState,
              n = e,
              e =
                (y && (n = e.setQueryParameters(re)), t.page ? t.page - 1 : 0);
  ...
  function sn(n) {
    ...
    return (
      ...
      function (l) {
        ...
        if (!0 === p && i <= r)
          throw new Error(
            ln("The `showMoreLimit` option must be greater than `limit`.")
          );
        var y = !1,
          b = function () {};
        function R() {
  ...
  function mn(e, t, n) {
    ...
    if (
      (fn(e, t, n) || (e = e.removeNumericRefinement(t)),
  ...
  function Sn(n) {
    ...
    return (
      ...
      function (o) {
        ...
        if (R(l) && R(d) && d < l)
          throw new Error(bn("The `max` option can't be lower than `min`."));
        var c = {
            from: function (e) {
              ...
              "" === e && _
                ? c(
                    C(
                      C(
                        {},
                        s.getWidgetRenderState(C(C({}, i), {}, { results: b }))
                      ),
                      {},
                      { instantSearchInstance: n }
                    ),
          ...
          getWidgetUiState: function (e, t) {
            ...
            return t.length
              ? C(
                  ...
                  {},
                  {
                    refinementList: C(C({}, e.refinementList), {}, E({}, f, t)),
                  }
                )
              : e;
          },
          getWidgetSearchParameters: function (e, t) {
            ...
            return e.isHierarchicalFacet(f) ||
              ...
              : ((t = t.refinementList && t.refinementList[f]),
                ...
                (n =
                  (e = r ? e.addDisjunctiveFacet(f) : e.addFacet(f))
                    .maxValuesPerFacet || 0),
                (n = Math.max(n, p ? a : m)),
                (e = e.setQueryParameter("maxValuesPerFacet", n)),
                t
              ...
              getWidgetUiState: function (e, t) {
                ...
                return "number" != typeof t
                  ...
                  : C(
                      C({}, e),
                      {},
                      { ratingMenu: C(C({}, e.ratingMenu), {}, E({}, S, t)) }
                    );
              },
              getWidgetSearchParameters: function (e, t) {
                (t = t.uiState),
  ...
  function Tn(u) {
    ...
    return function (s) {
      ...
      throw new Error(
        Bn("The `attributes` option expects an array of strings.")
      );
      function c(e, t) {
        return t
        ...
        return {
          ...
          render: function (e) {
            ...
            f("view:internal", r.items),
              g(C(C({}, r), {}, { instantSearchInstance: n }), !1);
          },
          getWidgetRenderState: function (e) {
            var t,
              n,
            ...
            return (
                ...
                })),
              {
                ...
                position: c(s),
                currentRefinement:
                  (e = s).insideBoundingBox && _e(e.insideBoundingBox),
                refine: function (e) {
                  var t = e.northEast,
                    e = e.southWest,
  ...
  (n.prototype._events = void 0),
    ...
    (n.prototype.emit = function (e) {
      ...
      if (
        ...
        (!this._events.error ||
          (Yn(this._events.error) && !this._events.error.length))
      )
        throw (o = arguments[1]) instanceof Error
          ...
          : (((s = new Error(
            ...
            s);
      if (Xn((t = this._events[e]))) return !1;
      if (Zn(t))
        ...
        if (Zn(t))
          return (
            ...
            this._events.newListener &&
              this.emit("newListener", e, Zn(t.listener) ? t.listener : t),
            this._events[e]
              ? Yn(this._events[e])
    ...
    (n.prototype.once = function (e, t) {
      var n;
      if (Zn(t)) return (n = !1), (r.listener = t), this.on(e, r), this;
      throw TypeError("listener must be a function");
      function r() {
    ...
    (n.prototype.removeListener = function (e, t) {
      var n, r, i, a;
      if (!Zn(t)) throw TypeError("listener must be a function");
      if (this._events && this._events[e])
        if (
          ((i = (n = this._events[e]).length),
          (r = -1),
          n === t || (Zn(n.listener) && n.listener === t))
        )
      ...
      if (this._events)
        if (this._events.removeListener)
          if (0 === arguments.length) {
            ...
            if (Zn((n = this._events[e]))) this.removeListener(e, n);
            else if (n)
  ...
  var d = {
      ...
      getSearchForFacetQuery: function (e, t, n, r) {
        ...
        return (
          ...
          cr(ar({}, d._getHitsSearchParams(r), t))
        );
      },
    },
    lr = d,
  ...
  var hr = function e(t) {
    ...
    fr = {
      ...
      removeRefinement: function (e, n, t) {
        var r;
        return void 0 === t
          ? fr.clearRefinement(e, function (e, t) {
              return n === t;
            })
          : ((r = "" + t),
            fr.clearRefinement(e, function (e, t) {
      ...
      toggleRefinement: function (e, t, n) {
        ...
        return fr.isRefined(e, t, n)
          ? fr.removeRefinement(e, t, n)
          : fr.addRefinement(e, t, n);
      },
  ...
  (s.PARAMETERS = Object.keys(new s())),
    ...
    (s.validate = function (e, t) {
      ...
      return e.tagFilters && t.tagRefinements && 0 < t.tagRefinements.length
        ...
        : e.numericFilters && t.numericRefinements && sr(t.numericRefinements)
        ? new Error(
            "[Numeric filters] Can't switch from the advanced to the managed API. It is probably an error, if this is really what you want, you have to first clear the numeric filters."
          )
        : sr(e.numericRefinements) && t.numericFilters
        ? new Error(
    ...
    (s.prototype = {
      ...
      addNumericRefinement: function (e, t, n) {
        ...
        return this.isNumericRefined(e, t, n)
          ? this
          : (((r = ar({}, this.numericRefinements))[e] = ar({}, r[e])),
            r[e][t]
          ...
          ? this.isNumericRefined(n, r, i)
            ? this.setQueryParameters({
                numericRefinements: this._clearNumericRefinements(function (
                  ...
                  return t === n && e.op === r && mr(e.val, hr(i));
                }),
              })
            : this
          : void 0 !== r
      ...
      _clearNumericRefinements: function (s) {
        var o, t, e;
        return void 0 === s
          ? sr(this.numericRefinements)
            ? {}
            : this.numericRefinements
          : "string" == typeof s
          ? or(this.numericRefinements, [s])
          : "function" == typeof s
          ? ((o = !1),
        ...
        if (this.isHierarchicalFacet(e))
          return (
            ...
            (this.hierarchicalFacetsRefinements[e][0] === t ||
              ...
              : (r[e] = [t]),
            this.setQueryParameters({
              hierarchicalFacetsRefinements: ur(
                {},
                r,
                this.hierarchicalFacetsRefinements
              ),
    ...
    Rr = function (m) {
      return function (e, t) {
        ...
        var a,
          ...
          r = vr(m._getHierarchicalFacetSortBy(r)),
    ...
    Object.keys(h).forEach(function (e) {
      ...
      s
        ? ((r = s.attributes.indexOf(e)),
          (n = gr(l.hierarchicalFacets, function (e) {
        ...
        : ((n = -1 !== l.disjunctiveFacets.indexOf(e)),
          ...
          n &&
            ...
            xr(d.disjunctiveFacets[i], o.facets_stats, e)),
          r &&
            ((i = c[e]),
            (d.facets[i] = {
              name: e,
            ...
            xr(d.facets[i], o.facets_stats, e)));
    }),
      (this.hierarchicalFacets = pr(this.hierarchicalFacets)),
      e.forEach(function (e) {
        var i = t[r],
        ...
        Object.keys(a).forEach(function (t) {
          ...
          s
            ? ((n = gr(l.hierarchicalFacets, function (e) {
              ...
              -1 !==
                (e = gr(d.hierarchicalFacets[n], function (e) {
                  return e.attribute === t;
                })) &&
                (d.hierarchicalFacets[n][e].data = ar(
                  {},
            ...
            : ((n = u[t]),
              ...
              xr(d.disjunctiveFacets[n], i.facets_stats, t),
          ...
          t.slice(r).forEach(function (e) {
            ...
            Object.keys(s).forEach(function (t) {
              var e,
                n,
                r = s[t],
                i = gr(l.hierarchicalFacets, function (e) {
                  return e.name === o.name;
                }),
                a = gr(d.hierarchicalFacets[i], function (e) {
                  return e.attribute === t;
                });
              -1 !== a &&
                ((e = {}),
                ...
                (d.hierarchicalFacets[i][a].data = ur(
                  e,
                  r,
      ...
      (this.hierarchicalFacets = this.hierarchicalFacets.map(Rr(l))),
      (this.facets = pr(this.facets)),
      (this.disjunctiveFacets = pr(this.disjunctiveFacets)),
      (this._state = l);
  }
  function Fr(n, r) {
    function e(e) {
    ...
    return n._state.isConjunctiveFacet(r)
      ...
      ? ((t = p(n.hierarchicalFacets, e)) &&
          ...
          (c = (o =
            0 ===
            (o = Pr(n._state.getHierarchicalRefinement(r)[0] || "")).indexOf(
              c.rootPath
            )
  ...
  (Ir.prototype.getFacetByName = function (t) {
    function e(e) {
      return e.name === t;
    }
    return (
    ...
    (Ir.DEFAULT_SORT = ["isRefined:desc", "count:desc", "name:asc"]),
    (Ir.prototype.getFacetValues = function (e, t) {
      var s,
        o,
        n = Fr(this, e);
      if (n)
          ...
          (function t(n, e, r, i) {
            ...
            function (e, t) {
              ...
              if (Array.isArray(s.sortBy))
                return (t = vr(s.sortBy, Ir.DEFAULT_SORT)), br(e, t[0], t[1]);
              if ("function" == typeof s.sortBy)
                return (a = s.sortBy), e.sort(a);
              throw new Error(
    ...
    (Ir.prototype.getFacetStats = function (e) {
      return this._state.isConjunctiveFacet(e)
        ? Tr(this.facets, e)
        : this._state.isDisjunctiveFacet(e)
        ? Tr(this.disjunctiveFacets, e)
        : void 0;
    }),
    (Ir.prototype.getRefinements = function () {
      var s = this._state,
        o = this,
        c = [];
      return (
  ...
  function t(e, t, n) {
    "function" == typeof e.addAlgoliaAgent &&
      e.addAlgoliaAgent("JS Helper (3.14.0)"),
      this.setClient(e);
    e = n || {};
    (e.index = t),
      (this.state = yr.make(e)),
  ...
  e(t, Jn),
        ...
        return this.client.search(e).then(
          function (e) {
            return (
              ...
              { content: new Er(n, e.results), state: n, _originalResponse: e }
            );
          },
          function (e) {
            throw (
    ...
    (t.prototype.findAnswers = function (e) {
      ...
      var n = n.getModifiedState(t),
        t = ar(
          ...
          {
            params: or(lr._getHitsSearchParams(n), [
              "attributesToSnippet",
              "hitsPerPage",
    ...
    (t.prototype.searchForFacetValues = function (t, e, n, r) {
      ...
      if (o || c || "function" == typeof this.client.search)
        return (
          ...
          (r = lr.getSearchForFacetQuery(t, e, n, i)),
    ...
    (t.prototype.hasRefinements = function (e) {
      return (
        !!sr(this.state.getNumericRefinements(e)) ||
        ...
        e =
          ...
          this.derivedHelpers.map(function (e) {
            var t = e.getModifiedState(r),
              n = t.index ? lr._getQueries(t.index, t) : [];
            return (
  ...
  (Or.version = nr),
    (Or.AlgoliaSearchHelper = Mr),
    (Or.SearchParameters = yr),
    (Or.SearchResults = Er);
  var Hr = Or,
          ...
          (t = {}),
          {
            ...
            getWidgetSearchParameters: function (e, t) {
              ...
              return Ke(
                e,
                new Hr.SearchParameters(
                  C(C({}, t.configure), r.searchParameters)
                )
              );
            },
            getWidgetUiState: function (e) {
              return C(
                C({}, e),
                {},
                { configure: C(C({}, e.configure), r.searchParameters) }
              );
            },
          }
        );
  ...
  var Yr = l({ name: "voice-search", connector: !0 }),
    ...
    nr = Object.freeze({
      __proto__: null,
      EXPERIMENTAL_connectAnswers: tr,
  ...
  var di = "2.6.0",
    hi = "https://cdn.jsdelivr.net/npm/search-insights@".concat(
      di,
        ...
        s = j(
          (e = r.client).transporter
            ? ((s = (n = e.transporter).headers),
              (n = n.queryParameters),
              [
                s[(t = "x-algolia-application-id")] || n[t],
        ...
        (!d && mi(m)) || m("init", C({ appId: o, apiKey: c, partial: !0 }, d)),
        {
          ...
          started: function () {
            m("addAlgoliaAgent", "insights-middleware"),
              (a = r.helper),
              (i = {
                userToken: a.state.userToken,
                clickAnalytics: a.state.clickAnalytics,
              }),
              a.overrideStateWithoutTriggeringChangeEvent(
                C(C({}, a.state), {}, { clickAnalytics: !0 })
              ),
              f || r.scheduleSearch();
            function e(e) {
              var t;
            ...
            var t = oi(),
              n =
                (t && e(t, !0),
                l
                  ? (e(l, !0), m("setUserToken", l))
                  : u && (e(u, !0), m("setUserToken", u)),
      ...
      parse: function (e, t) {
        var n = (function (e) {
          ...
          return {
            ...
            allowPrototypes: ("boolean" == typeof e.allowPrototypes ? e : f)
              .allowPrototypes,
            arrayLimit: ("number" == typeof e.arrayLimit ? e : f).arrayLimit,
            charset: t,
            charsetSentinel: ("boolean" == typeof e.charsetSentinel ? e : f)
              .charsetSentinel,
            ...
            parameterLimit: ("number" == typeof e.parameterLimit ? e : f)
              .parameterLimit,
            parseArrays: !1 !== e.parseArrays,
            plainObjects: ("boolean" == typeof e.plainObjects ? e : f)
              .plainObjects,
              ...
              if (e) {
                ...
                for (
                  ...
                  if (
                    ((c += 1),
                    !n.plainObjects &&
                      Mi.call(Object.prototype, s[1].slice(1, -1)) &&
                      !n.allowPrototypes)
                  )
                    return;
                  o.push(s[1]);
                ...
                return (
                  s && o.push("[" + i.slice(s.index) + "]"), Bi(o, t, n, r)
                );
              }
      ...
      stringify: function (e, t) {
        var n = e,
          r = (function (e) {
            ...
            var n = _i.default;
            if (void 0 !== e.format) {
              if (!Ii.call(_i.formatters, e.format))
            ...
            var r = _i.formatters[n],
              i = x.filter;
            return (
              ("function" != typeof e.filter && !Ti(e.filter)) ||
                (i = e.filter),
              {
                addQueryPrefix: ("boolean" == typeof e.addQueryPrefix ? e : x)
                  .addQueryPrefix,
                allowDots: void 0 === e.allowDots ? x.allowDots : !!e.allowDots,
                charset: t,
                charsetSentinel: ("boolean" == typeof e.charsetSentinel ? e : x)
                  .charsetSentinel,
                ...
                format: n,
                formatter: r,
                serializeDate: ("function" == typeof e.serializeDate ? e : x)
                  .serializeDate,
          ...
          i =
            ("function" == typeof r.filter
              ? (n = (0, r.filter)("", n))
              : Ti(r.filter) && (s = r.filter),
            []);
        if ("object" != typeof n || null === n) return "";
        var e =
            t && t.arrayFormat in Fi
              ? t.arrayFormat
  ...
  function ea(e) {
    if (void 0 === e || void 0 === e.indexName)
      throw new Error(Zi("The `indexName` option is required."));
    var s = e.indexName,
    ...
    return {
      ...
      addWidgets: function (e) {
        ...
        if (!Array.isArray(e))
          throw new Error(
            Zi("The `addWidgets` method expects an array of widgets.")
          );
        if (
          e.some(function (e) {
        ...
        return (
          ...
          l &&
            Boolean(e.length) &&
            (Yi(h, {
              state: Gi(c, { uiState: u, initialSearchParameters: h.state }),
              _uiState: u,
            }),
            e.forEach(function (e) {
              e.getRenderState &&
      ...
      removeWidgets: function (t) {
        ...
        if (!Array.isArray(t))
          throw new Error(
            Zi("The `removeWidgets` method expects an array of widgets.")
          );
        if (
          t.some(function (e) {
          ...
          throw new Error(
            Zi("The widget definition expects a `dispose` method.")
          );
        return (
      ...
      init: function (e) {
        ...
        null === h &&
          ...
          (e = Gi(c, {
            uiState: u,
            initialSearchParameters: new Hr.SearchParameters({ index: s }),
          })),
          ...
          (e =
            null == (r = n._initialResults) ? void 0 : r[this.getIndexId()]) &&
            ((r = new Hr.SearchResults(
              new Hr.SearchParameters(e.state),
              e.results
            )),
            (f.lastResults = r),
            (h.lastResults = r)),
            ...
            e.isPageReset &&
              !(function n(e) {
                ...
                0 !== e.length &&
                  e.forEach(function (e) {
                    var t = e.getHelper();
                    Yi(t, { state: t.state.resetPage(), isPageReset: !0 }),
                      n(e.getWidgets());
                  });
              })(c);
          }),
          ...
          h.on("change", function (e) {
            var t = e.state,
              e = e._uiState;
            (u = Xi(c, { searchParameters: t, helper: h }, e || {})),
  ...
  var sa = (function () {
      ...
      function f(e) {
        ...
        var n,
          ...
          e = void 0 === e ? null : e;
        if (null === l)
          throw new Error(ia("The `searchClient` option is required."));
        ...
        if (
          ("function" == typeof l.addAlgoliaAgent &&
            l.addAlgoliaAgent("instantsearch.js (".concat(ra, ")")),
          d && "function" != typeof d)
        )
          throw new Error(
            ia("The `insightsClient` option should be a function.")
          );
        return (
          (n.client = l),
          (n.insightsClient = d),
          ...
          s &&
            (((l = "boolean" == typeof s ? {} : s).$$internal = !0),
            n.use(zi(l))),
          o &&
            (((d = "boolean" == typeof o ? {} : o).$$internal = !0),
            n.use(fi(d))),
        ...
        W(f, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                throw new Error(
                  ia("The widget definition expects a `dispose` method.")
                );
          ...
          },
          {
            ...
            value: function () {
              ...
              if (this.started)
                throw new Error(
                  ia("The `start` method has already been called once.")
                );
              var n,
                e,
              ...
              (i.search = function () {
                return (
                  (r.status = "loading"),
                  r.scheduleRender(!1),
                  i.searchOnlyWithDerivedHelpers()
                );
              }),
            ...
            value: function (e) {
              ...
              this.onStateChange && n
                ? this.onStateChange({
                    uiState: r,
                    setUiState: function (e) {
                      pe("function" == typeof e ? e(r) : e, t.mainIndex),
                        t.scheduleSearch(),
          ...
          },
          {
            ...
            value: function () {
              ...
              throw new Error(
                ia("The `start` method needs to be called before `createURL`.")
              );
            },
          },
          {
            ...
            value: function () {
              if (!this.mainHelper)
                throw new Error(
                  ia("The `start` method needs to be called before `refresh`.")
                );
  ...
  var e = la(function (e, t) {
    ...
    ha = ((e.Template = da.Template), (e.template = e.Template), e),
    fa = function (e, t, n, r) {
      t[0] = 0;
  ...
  (Sa = (e = { createElement: L, Fragment: kt }).createElement),
    (_a = e.Fragment),
    (Ra = { createElement: Sa, Fragment: _a }.createElement);
  var Ra,
    Sa,
    _a,
    wa = function (e) {
      ...
      return Sa(
        ...
        r.map(function (e, t) {
          ...
          return Sa(
            ...
            !n && Sa("span", { className: o.separator }, s)
          );
        })
      );
    };
  ...
  var Ia = ["hit", "attribute", "cssClasses"];
  function Fa(e) {
    var t = e.hit,
      n = e.attribute,
      r = e.cssClasses;
  ...
  var Ea = ["hit", "attribute", "cssClasses"],
    ka = ["isHighlighted"];
  function ja(e) {
    var t = e.hit,
      n = e.attribute,
      ...
      m({}, k(e, Ea), {
        parts: et(Ne(t._highlightResult, n) || []).map(function (e) {
          return we(te(e.value || "")).map(function (e) {
            ...
            return C(C({}, k(e, ka)), {}, { isHighlighted: !t });
          });
        }),
        classNames: r,
      })
  ...
  var Oa = ["hit", "attribute", "cssClasses"],
    Ha = ["isHighlighted"];
  function Aa(e) {
    var t = e.hit,
      n = e.attribute,
    ...
    return L(
      ...
      m({}, k(e, Oa), {
        parts: et(Ne(t._snippetResult, n) || []).map(function (e) {
          return we(te(e.value || "")).map(function (e) {
            var t = e.isHighlighted;
            return C(C({}, k(e, Ha)), {}, { isHighlighted: !t });
          });
        }),
        classNames: r,
      })
  ...
  var Ba = ["hit", "attribute", "cssClasses"];
  function Ua(e) {
    var t = e.hit,
      n = e.attribute,
      r = e.cssClasses;
              ...
              E({}, n, function () {
                ...
                return function (e) {
                  return r[n].call(a, e, function (e) {
                    return ha.compile(e, i).render(t);
                  });
                };
              })
            );
  ...
  var g = (function () {
    ...
    Va = l({ name: "answers" }),
    Ka = i("Answers"),
    za = ["container", "widgets", "fallbackWidget"],
    Ja = l({ name: "dynamic-widgets" }),
    Za = i("DynamicWidgets");
  function Ya(e) {
    var t = document.createElement("div");
    return (
      (t.className = Za({ descendantName: "widget" })), e.appendChild(t), t
    );
  }
  function Xa(e) {
    var n,
      ...
      c = e.fallbackWidget,
      e = k(e, za);
    if (!r) throw new Error(Ja("The `container` option is required."));
    if (
      o &&
      Array.isArray(o) &&
      o.every(function (e) {
      ...
      return (
        (n = P(r)),
        ((i = document.createElement("div")).className = Za()),
        (a = new Map()),
        (s = []),
        (t = nt(
          function (e, t) {
    ...
    throw new Error(Ja("The `widgets` option expects an array of callbacks."));
  }
  function Ga(e, t) {
    var n = e.items,
      r = e.widgetParams,
    ...
    t ||
      ((t = r.container),
      (r = r.cssClasses),
      M(L(hs, { cssClasses: r, items: n, canRefine: e }), t));
  }
  function es(e) {
    var t = e.className,
      n = e.disabled;
  ...
  function ns(e, t) {
    ...
    t
          ...
          T.mapInstance.addListener("center_changed", e),
            ...
            T.mapInstance.addListener("idle", function () {
              T.isUserInteraction &&
                T.isPendingRefine &&
                ((T.isPendingRefine = !1),
                ys({ mapInstance: T.mapInstance, refine: u }));
            });
        }),
        (T.templateProps = O({
          templatesConfig: e.templatesConfig,
      ...
      : ((g = s.map(function (e) {
        ...
        (R = !m()),
        (i = c ? 0 : null),
        (a = !c && Boolean(T.markers.length) ? Rs(y, T.markers) : c) && R
          ? Ss(T, function () {
        ...
        M(
          L(vs, {
            ...
            onRefineClick: function () {
              return ys({ mapInstance: T.mapInstance, refine: u });
            },
            onClearClick: l,
  ...
  var rs = l({ name: "analytics" }),
      ...
      return L(
        ...
        L(
          ...
          m({}, e, {
            ...
            rootTagName: "button",
            rootProps: {
              className: I(r.button, !t && r.disabledButton),
              onClick: n,
              disabled: !t,
            },
    ...
    ls = l({ name: "clear-refinements" }),
    ds = i("ClearRefinements"),
    hs = function (e) {
      var t = e.items,
        a = e.cssClasses,
        e = e.canRefine;
    ...
    fs = l({ name: "current-refinements" }),
    ms = i("CurrentRefinements"),
    ps = L("p", null, "Your custom HTML Marker"),
    gs = {
      HTMLMarker: function () {
        return ps;
      },
          ...
          L(
              ...
              L(
                ...
                a || !o
                  ? L(
                      ...
                      L(
                        g,
                        m({}, e, { templateKey: "toggle", rootTagName: "span" })
                      )
                    )
                  : L(
                      es,
                      ...
                      L(
                        g,
                        m({}, e, { templateKey: "redo", rootTagName: "span" })
                      )
                    )
              ),
            !r &&
              ...
              L(
                ...
                L(
                  es,
                  {
                    className: I(t.redo, !o && t.disabledRedo),
                    disabled: !o,
                    onClick: u,
                  },
            ...
            i &&
              ...
              L(
                ...
                L(g, m({}, e, { templateKey: "reset", rootTagName: "span" }))
              )
          )
      );
    },
  ...
  var Es = (function () {
            ...
            var t,
              ...
              i =
                ...
                I(
                  ...
                  Boolean(
                    Cs(e) && Array.isArray(e.data) && 0 < e.data.length
    ...
    ks =
      (E(Es, "defaultProps", { cssClasses: {}, depth: 0 }),
      {
        item: function (e) {
          var t = e.url,
            n = e.label,
          ...
          return L(
            "a",
            {
              className: I(I(i.link), I(e ? i.selectedItemLink : void 0)),
              href: t,
            },
  ...
  function Ls(e) {
    ...
    return 0 === t.hits.length
      ? L(
          ...
          m({}, o, {
            templateKey: "empty",
            rootProps: { className: I(s.root, s.emptyRoot), onClick: c },
            data: t,
          })
        )
      : L(
    ...
    Bs = function (e) {
      ...
      return 0 === t.hits.length
        ? L(
            ...
            m({}, h, {
              templateKey: "empty",
              rootProps: { className: I(d.root, d.emptyRoot), onClick: f },
              data: t,
            })
          )
        : L(
            ...
            s &&
              L(
                ...
                m({}, h, {
                  ...
                  rootTagName: "button",
                  rootProps: {
                    className: I(d.loadPrevious, u && d.disabledLoadPrevious),
                    disabled: u,
                    onClick: o,
                  },
                })
            ...
            L(
              ...
              m({}, h, {
                ...
                rootTagName: "button",
                rootProps: {
                  className: I(d.loadMore, l && d.disabledLoadMore),
                  disabled: l,
                  onClick: c,
                },
              })
  ...
  var ro,
    ...
    go = N.unmount;
  function vo(e, t) {
    N.__h && N.__h(_, e, co || t), (co = 0);
    t = _.__H || (_.__H = { __: [], __h: [] });
    return e >= t.__.length && t.__.push({ __V: lo }), t.__[e];
  }
  function yo(e) {
    co = 1;
    var a,
  ...
  function Ro() {
    for (var t; (t = uo.shift()); )
      if (t.__P && t.__H)
        try {
          t.__H.__h.forEach(_o), t.__H.__h.forEach(wo), (t.__H.__h = []);
        } catch (e) {
        ...
        (io === _
          ? ((e.__h = []),
            ...
            e.__.forEach(function (e) {
              e.__N && (e.__ = e.__N), (e.__V = lo), (e.__N = e.i = void 0);
            }))
          : (e.__h.forEach(_o), e.__h.forEach(wo), (e.__h = []))),
        (io = _);
    }),
    (N.diffed = function (e) {
      mo && mo(e);
      ...
      e &&
        e.__H &&
        (!e.__H.__h.length ||
          (1 !== uo.push(e) && ao === N.requestAnimationFrame) ||
          (
            (ao = N.requestAnimationFrame) ||
            function (e) {
              function t() {
                clearTimeout(r), So && cancelAnimationFrame(n), setTimeout(e);
              }
              var n,
                r = setTimeout(t, 100);
              So && (n = requestAnimationFrame(t));
            }
          )(Ro),
  ...
  var So = "function" == typeof requestAnimationFrame;
  function _o(e) {
    var t = _,
      n = e.__c;
  ...
  function xo(t) {
    ...
    return (
      ...
      (e = [c, t.bodyElement]),
      (n = vo(ro++, 3)),
      !N.__s && Po(n.__H, e) && ((n.__ = r), (n.i = e), _.__H.__h.push(n)),
  ...
  var Io = l({ name: "panel" }),
    Fo = i("Panel"),
    To = ["placesReference", "defaultPosition"],
    Co = ["places"],
    Eo = function (e) {
      var t = e.url,
        n = e.theme,
    ...
    ko = i("PoweredBy"),
    jo = l({ name: "powered-by" }),
    Lo = l({ name: "query-rule-context" }),
    Mo = function (e) {
      var t = e.cssClasses,
        n = e.templates,
        e = e.items;
    ...
    Ho = l({ name: "query-rule-custom-data" }),
    Ao = i("QueryRuleCustomData");
  function Wo(e) {
  ...
  var sc = L("div", { className: "rheostat-background" }),
    oc = (function () {
      D(i, jt);
      var r = $(i);
      function i() {
        ...
        return (
          ...
          E(b(f), "state", {
            className: rc(f.props),
            handlePos: f.props.values.map(function (e) {
              return tc(e, f.props.min, f.props.max);
            }),
            handleDimensions: 0,
            mousePos: null,
            sliderBox: {},
          ...
          E(b(f), "getHandleDimensions", function (e, t) {
            ...
            return e
              ? "vertical" === f.props.orientation
                ? ((e.clientHeight / t.height) * ec) / 2
                : ((e.clientWidth / t.width) * ec) / 2
              : 0;
          }),
          ...
          E(b(f), "getSnapPosition", function (e) {
            ...
            return f.props.snap
              ? ((t = (n = f.props).max),
                (r = nc(e, (n = n.min), t)),
                tc(f.getClosestSnapPoint(r), n, t))
              : e;
          }),
              ...
              (r += e[t](l)),
                o &&
                  ...
                  (u < r
                    ...
                    : 0 < d && (c = i[d - 1]));
            else if (t === zo) (r = 0), o && (c = i[0]);
            else {
              if (t !== Vo) return null;
              (r = ec), o && (c = i[i.length - 1]);
            }
            return o ? tc(c, s, a) : r;
          }),
          ...
          E(b(f), "handleMouseSlide", function (e) {
            null !== f.state.slidingIndex &&
              (f.handleSlide(e.clientX, e.clientY), ac(e));
          }),
          ...
          E(b(f), "validatePosition", function (e, t) {
            ...
            return Math.max(
              Math.min(t, void 0 !== r[e + 1] ? r[e + 1] - n : ec),
            ...
            },
            {
              ...
              value: function (e) {
                var t = e.min,
                  ...
                  e = e.step;
                if (e)
                  return [].concat(w(Je({ start: t, end: n, step: e })), [n]);
              },
            },
            {
              key: "render",
  ...
  var hc = {
    ...
    Nc = l({ name: "relevant-sort" }),
    xc = i("RelevantSort"),
    Ic = l({ name: "search-box" }),
    Fc = i("SearchBox"),
    Tc = l({ name: "sort-by" }),
    Cc = i("SortBy"),
    Ec = ["nbHits", "nbSortedHits", "cssClasses", "templateProps"],
    kc = function (e) {
      var t = e.nbHits,
        n = e.nbSortedHits,
        r = e.cssClasses,
          ...
          .concat(
            (e.areHitsSorted
              ? function (e) {
                  ...
                  if (i)
                    return ""
                      .concat(na(e || 0), " relevant results ")
                      .concat(t);
                  return "";
                }
              : function (e) {
  ...
  var Hc = function (e) {
    ...
    Wc = l({ name: "toggle-refinement" }),
    Dc = i("ToggleRefinement"),
    Bc = function (e) {
      var t = e.cssClasses,
    ...
    $c = L("path", { d: "M19 10v2a7 7 0 0 1-14 0v-2" }),
    qc = L("line", { x1: "12", y1: "19", x2: "12", y2: "23" }),
    ...
    Vc = {
      buttonText: function (e) {
        ...
        return L(
          ...
          L(Oc, { status: t, errorCode: n, isListening: e })
        );
      },
      status: function (e) {
    ...
    e = K(function (e) {
      ...
      if (n)
        return (
          ...
          (n = {
            root: I(Ka(), e.root),
            emptyRoot: I(Ka({ modifierName: "empty" }), e.emptyRoot),
            header: I(Ka({ descendantName: "header" }), e.header),
            loader: I(Ka({ descendantName: "loader" }), e.loader),
            list: I(Ka({ descendantName: "list" }), e.list),
            item: I(Ka({ descendantName: "item" }), e.item),
          }),
          (i = (e = {
            containerNode: t,
            cssClasses: n,
      ...
      throw new Error(Va("The `container` option is required."));
    }),
    da = K(Xa),
    e = Object.freeze({
      __proto__: null,
      EXPERIMENTAL_answers: e,
      EXPERIMENTAL_dynamicWidgets: da,
      dynamicWidgets: Xa,
      analytics: function (e) {
            ...
            (r = function (e) {
              ...
              null !== e &&
                ...
                (n = i(
                  C(
                    C(
                      C({}, e.state.disjunctiveFacetsRefinements),
        ...
        throw new Error(rs("The `pushFunction` option is required."));
      },
      breadcrumb: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(os(), e.root),
              noRefinementRoot: I(
                os({ modifierName: "noRefinement" }),
                e.noRefinementRoot
              ),
              list: I(os({ descendantName: "list" }), e.list),
              item: I(os({ descendantName: "item" }), e.item),
              selectedItem: I(
                os({ descendantName: "item", modifierName: "selected" }),
                e.selectedItem
              ),
              separator: I(os({ descendantName: "separator" }), e.separator),
              link: I(os({ descendantName: "link" }), e.link),
            }),
            (s = (e = {
              containerNode: t,
              cssClasses: n,
        ...
        throw new Error(ss("The `container` option is required."));
      },
      clearRefinements: function (e) {
        var t,
          i,
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(ds(), e.root),
              button: I(ds({ descendantName: "button" }), e.button),
              disabledButton: I(
                ds({ descendantName: "button", modifierName: "disabled" }),
                e.disabledButton
              ),
            }),
            (i = (e = {
        ...
        throw new Error(ls("The `container` option is required."));
      },
      configure: function (e) {
        return C(
          C({}, Dr(v)({ searchParameters: e })),
          {},
      ...
      currentRefinements: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(ms(), a.root),
              noRefinementRoot: I(
                ms({ modifierName: "noRefinement" }),
                a.noRefinementRoot
              ),
              list: I(ms({ descendantName: "list" }), a.list),
              item: I(ms({ descendantName: "item" }), a.item),
              label: I(ms({ descendantName: "label" }), a.label),
              category: I(ms({ descendantName: "category" }), a.category),
              categoryLabel: I(
                ms({ descendantName: "categoryLabel" }),
                a.categoryLabel
              ),
              delete: I(ms({ descendantName: "delete" }), a.delete),
            }),
            C(
              C(
                {},
        ...
        throw new Error(fs("The `container` option is required."));
      },
      ...
      geoSearch: function (e) {
        var t,
          ...
          v = e.googleReference,
          e = k(e, _s);
        if (!g) throw new Error(Ns("The `container` option is required."));
        if (v)
          return (
            (t = P(g)),
            (g = {
              root: I(xs(), l.root),
              tree: xs({ descendantName: "tree" }),
              map: I(xs({ descendantName: "map" }), l.map),
              control: I(xs({ descendantName: "control" }), l.control),
              label: I(xs({ descendantName: "label" }), l.label),
              selectedLabel: I(
                xs({ descendantName: "label", modifierName: "selected" }),
                l.selectedLabel
              ),
              input: I(xs({ descendantName: "input" }), l.input),
              redo: I(xs({ descendantName: "redo" }), l.redo),
              disabledRedo: I(
                xs({ descendantName: "redo", modifierName: "disabled" }),
                l.disabledRedo
              ),
              reset: I(xs({ descendantName: "reset" }), l.reset),
            }),
            (n = C(C({}, gs), c)),
            (r = C(
              C(
                  ...
                  return new a(
                    C(
                      ...
                      {},
                      {
                        __id: t.objectID,
                        position: t._geoloc,
                        className: I(xs({ descendantName: "marker" })),
                        template: $a({
        ...
        throw new Error(Ns("The `googleReference` option is required."));
      },
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(S(), e.root),
              noRefinementRoot: I(
                S({ modifierName: "noRefinement" }),
                e.noRefinementRoot
              ),
              list: I(S({ descendantName: "list" }), e.list),
              childList: I(
                S({ descendantName: "list", modifierName: "child" }),
                e.childList
              ),
              item: I(S({ descendantName: "item" }), e.item),
              selectedItem: I(
                S({ descendantName: "item", modifierName: "selected" }),
                e.selectedItem
              ),
              parentItem: I(
                S({ descendantName: "item", modifierName: "parent" }),
                e.parentItem
              ),
              link: I(S({ descendantName: "link" }), e.link),
              selectedItemLink: I(
                S({ descendantName: "link", modifierName: "selected" }),
                e.selectedItemLink
              ),
              ...
              disabledShowMore: I(
                S({ descendantName: "showMore", modifierName: "disabled" }),
                e.disabledShowMore
              ),
            }),
            (c = (e = {
      ...
      hits: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(Hs(), e.root),
              emptyRoot: I(Hs({ modifierName: "empty" }), e.emptyRoot),
              list: I(Hs({ descendantName: "list" }), e.list),
              item: I(Hs({ descendantName: "item" }), e.item),
            }),
            (o = (e = {
              containerNode: t,
              cssClasses: n,
        ...
        throw new Error(Os("The `container` option is required."));
      },
      hitsPerPage: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(Ds(), s.root),
              select: I(Ds({ descendantName: "select" }), s.select),
              option: I(Ds({ descendantName: "option" }), s.option),
            }),
        ...
        throw new Error(Ws("The `container` option is required."));
      },
      index: ea,
      infiniteHits: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(qs(), s.root),
              emptyRoot: I(qs({ modifierName: "empty" }), s.emptyRoot),
              item: I(qs({ descendantName: "item" }), s.item),
              list: I(qs({ descendantName: "list" }), s.list),
              loadPrevious: I(
                qs({ descendantName: "loadPrevious" }),
                s.loadPrevious
              ),
              ...
              loadMore: I(qs({ descendantName: "loadMore" }), s.loadMore),
              disabledLoadMore: I(
                qs({ descendantName: "loadMore", modifierName: "disabled" }),
                s.disabledLoadMore
              ),
            }),
            (d = (s = {
        ...
        throw new Error($s("The `container` option is required."));
      },
      menu: function (e) {
        var t,
          c,
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(Ks(), f.root),
              noRefinementRoot: I(
                Ks({ modifierName: "noRefinement" }),
                f.noRefinementRoot
              ),
              list: I(Ks({ descendantName: "list" }), f.list),
              item: I(Ks({ descendantName: "item" }), f.item),
              selectedItem: I(
                Ks({ descendantName: "item", modifierName: "selected" }),
                f.selectedItem
              ),
              link: I(Ks({ descendantName: "link" }), f.link),
              label: I(Ks({ descendantName: "label" }), f.label),
              count: I(Ks({ descendantName: "count" }), f.count),
              showMore: I(Ks({ descendantName: "showMore" }), f.showMore),
              disabledShowMore: I(
                Ks({ descendantName: "showMore", modifierName: "disabled" }),
                f.disabledShowMore
              ),
            }),
            (c = (f = {
        ...
        throw new Error(Vs("The `container` option is required."));
      },
        ...
        if (n)
          return (
            ...
            (n = {
              ...
              select: I(Ys({ descendantName: "select" }), l.select),
              option: I(Ys({ descendantName: "option" }), l.option),
            }),
            (i = (l = {
              containerNode: t,
              cssClasses: n,
      ...
      numericMenu: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(eo(), l.root),
              noRefinementRoot: I(
                eo({ modifierName: "noRefinement" }),
                l.noRefinementRoot
              ),
              list: I(eo({ descendantName: "list" }), l.list),
              item: I(eo({ descendantName: "item" }), l.item),
              selectedItem: I(
                eo({ descendantName: "item", modifierName: "selected" }),
                l.selectedItem
              ),
              label: I(eo({ descendantName: "label" }), l.label),
              radio: I(eo({ descendantName: "radio" }), l.radio),
              labelText: I(eo({ descendantName: "labelText" }), l.labelText),
            }),
            (a = (l = {
              containerNode: t,
              attribute: r,
        ...
        throw new Error(Gs("The `container` option is required."));
      },
      pagination: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(F(), i.root),
              noRefinementRoot: I(
                F({ modifierName: "noRefinement" }),
                i.noRefinementRoot
              ),
              list: I(F({ descendantName: "list" }), i.list),
              item: I(F({ descendantName: "item" }), i.item),
              firstPageItem: I(
                F({ descendantName: "item", modifierName: "firstPage" }),
                i.firstPageItem
              ),
              lastPageItem: I(
                F({ descendantName: "item", modifierName: "lastPage" }),
                i.lastPageItem
              ),
              previousPageItem: I(
                F({ descendantName: "item", modifierName: "previousPage" }),
                i.previousPageItem
              ),
              nextPageItem: I(
                F({ descendantName: "item", modifierName: "nextPage" }),
                i.nextPageItem
              ),
              pageItem: I(
                F({ descendantName: "item", modifierName: "page" }),
                i.pageItem
              ),
              selectedItem: I(
                F({ descendantName: "item", modifierName: "selected" }),
                i.selectedItem
              ),
              disabledItem: I(
                F({ descendantName: "item", modifierName: "disabled" }),
                i.disabledItem
              ),
        ...
        throw new Error(so("The `container` option is required."));
      },
      panel: function (e) {
        var e = e || {},
          t = e.templates,
          ...
          p = {
            ...
            collapsibleRoot: I(
              Fo({ modifierName: "collapsible" }),
              e.collapsibleRoot
            ),
            collapsedRoot: I(
              Fo({ modifierName: "collapsed" }),
              e.collapsedRoot
            ),
            collapseButton: I(
              Fo({ descendantName: "collapseButton" }),
              e.collapseButton
            ),
            collapseIcon: I(
              Fo({ descendantName: "collapseIcon" }),
              e.collapseIcon
            ),
            body: I(Fo({ descendantName: "body" }), e.body),
            header: I(Fo({ descendantName: "header" }), e.header),
            footer: I(Fo({ descendantName: "footer" }), e.footer),
          };
        return function (n) {
          return function (e) {
            var i, a, t, s, o, c, u, l;
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(
                ko(),
                ko({ modifierName: "dark" === e ? "dark" : "light" }),
                a.root
              ),
              link: I(ko({ descendantName: "link" }), a.link),
              logo: I(ko({ descendantName: "logo" }), a.logo),
            }),
      ...
      queryRuleContext: function () {
        ...
        throw new Error(Lo("The `trackedFilters` option is required."));
      },
            ...
            C(
              C(
                ...
                Kr(
                  function (e) {
                    e = e.items;
                    M(L(Mo, { cssClasses: r, templates: i, items: e }), n);
                  },
                  function () {
                    M(null, t);
                  }
      ...
      rangeInput: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I($o(), d.root),
              noRefinement: I($o({ modifierName: "noRefinement" })),
              form: I($o({ descendantName: "form" }), d.form),
              label: I($o({ descendantName: "label" }), d.label),
              input: I($o({ descendantName: "input" }), d.input),
              inputMin: I(
                $o({ descendantName: "input", modifierName: "min" }),
                d.inputMin
              ),
              inputMax: I(
                $o({ descendantName: "input", modifierName: "max" }),
                d.inputMax
              ),
              separator: I($o({ descendantName: "separator" }), d.separator),
              submit: I($o({ descendantName: "submit" }), d.submit),
            }),
            (s = (d = {
              containerNode: t,
              cssClasses: n,
        ...
        throw new Error(Uo("The `container` option is required."));
      },
      rangeSlider: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(lc(), d.root),
              disabledRoot: I(lc({ modifierName: "disabled" }), d.disabledRoot),
            }),
            (a = (d = {
              containerNode: t,
              step: h,
        ...
        throw new Error(uc("The `container` option is required."));
      },
      ...
      refinementList: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              ...
              selectedItem: I(
                H({ descendantName: "item", modifierName: "selected" }),
                _.selectedItem
              ),
              ...
              disabledShowMore: I(
                H({ descendantName: "showMore", modifierName: "disabled" }),
                _.disabledShowMore
              ),
              searchable: {
                root: I(_c(), _.searchableRoot),
                form: I(_c({ descendantName: "form" }), _.searchableForm),
                input: I(_c({ descendantName: "input" }), _.searchableInput),
                submit: I(_c({ descendantName: "submit" }), _.searchableSubmit),
                submitIcon: I(
                  _c({ descendantName: "submitIcon" }),
                  _.searchableSubmitIcon
                ),
                reset: I(_c({ descendantName: "reset" }), _.searchableReset),
                resetIcon: I(
                  _c({ descendantName: "resetIcon" }),
                  _.searchableResetIcon
                ),
                loadingIndicator: I(
                  _c({ descendantName: "loadingIndicator" }),
                  _.searchableLoadingIndicator
                ),
                loadingIcon: I(
                  _c({ descendantName: "loadingIcon" }),
        ...
        throw new Error(Sc("The `container` option is required."));
      },
      relevantSort: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(xc(), e.root),
              text: I(xc({ descendantName: "text" }), e.text),
              button: I(xc({ descendantName: "button" }), e.button),
            }),
            (e = C(C({}, Pc), s)),
            (r = (s = {
              containerNode: t,
        ...
        throw new Error(Nc("The `container` option is required."));
      },
      searchBox: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(Fc(), f.root),
              form: I(Fc({ descendantName: "form" }), f.form),
              input: I(Fc({ descendantName: "input" }), f.input),
              submit: I(Fc({ descendantName: "submit" }), f.submit),
              submitIcon: I(Fc({ descendantName: "submitIcon" }), f.submitIcon),
              reset: I(Fc({ descendantName: "reset" }), f.reset),
              resetIcon: I(Fc({ descendantName: "resetIcon" }), f.resetIcon),
              loadingIndicator: I(
                Fc({ descendantName: "loadingIndicator" }),
                f.loadingIndicator
              ),
              loadingIcon: I(
                Fc({ descendantName: "loadingIcon" }),
                f.loadingIcon
              ),
            }),
            (f = C(C({}, bc), e)),
      ...
      sortBy: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(Cc(), s.root),
              select: I(Cc({ descendantName: "select" }), s.select),
              option: I(Cc({ descendantName: "option" }), s.option),
            }),
      ...
      stats: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(Lc(), r.root),
              text: I(Lc({ descendantName: "text" }), r.text),
            }),
            (l = (r = {
              containerNode: t,
              cssClasses: n,
        ...
        throw new Error(jc("The `container` option is required."));
      },
      toggleRefinement: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(Dc(), c.root),
              label: I(Dc({ descendantName: "label" }), c.label),
              checkbox: I(Dc({ descendantName: "checkbox" }), c.checkbox),
              labelText: I(Dc({ descendantName: "labelText" }), c.labelText),
            }),
            (i = (c = {
              containerNode: t,
              cssClasses: n,
      ...
      voiceSearch: function (e) {
        ...
        if (n)
          return (
            ...
            (n = {
              root: I(zc(), r.root),
              button: I(zc({ descendantName: "button" }), r.button),
              status: I(zc({ descendantName: "status" }), r.status),
            }),
            (r = C(C({}, Vc), o)),
