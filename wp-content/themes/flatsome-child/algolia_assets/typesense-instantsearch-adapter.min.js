...
!(function (t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.TypesenseInstantSearchAdapter = e())
    : (t.TypesenseInstantSearchAdapter = e());
})(self, () =>
  (() => {
    var t = {
        9669: (t, e, n) => {
          ...
          t.exports = function (t) {
            return new Promise(function (e, n) {
              ...
              if (
                ...
                (b.onabort = function () {
                  b &&
                    (n(l("Request aborted", t, "ECONNABORTED", b)), (b = null));
                }),
                (b.onerror = function () {
                ...
                var S =
                  (t.withCredentials || c(w)) && t.xsrfCookieName
          ...
          !(function (i, a) {
            ...
            (r = function () {
              ...
              function s(t, n, r) {
                return function () {
                  typeof console !== e &&
                    (a.call(this, n, r), this[t].apply(this, arguments));
                };
              }
              function u(r, a, u) {
                return (
              ...
              l.getLogger = function (t) {
                ...
                var e = f[t];
                return (
                  e || (e = f[t] = new c(t, l.getLevel(), l.methodFactory)), e
                );
              };
              ...
              return (
                (l.noConflict = function () {
                  return (
                    typeof window !== e && window.log === l && (window.log = h),
                    l
                  );
                }),
        ...
        8871: function (t, e, n) {
          ...
          e.Client = s.default;
          var u = a(n(8834));
          e.SearchClient = u.default;
          var c = i(n(6718));
          (e.Errors = c),
            (e.default = {
              Client: s.default,
              SearchClient: u.default,
              Errors: c,
            });
        },
        8480: function (t, e, n) {
            ...
            a = (function () {
              function t(t) {
                (this.apiCall = t),
                  ...
                  (this.apiCall = t),
                  (this._analyticsRules = new o.default(this.apiCall));
              }
              return (
                (t.prototype.rules = function (t) {
                  return void 0 === t
                    ? this._analyticsRules
                    : (void 0 === this.individualAnalyticsRules[t] &&
                        (this.individualAnalyticsRules[t] = new i.default(
                          t,
                          this.apiCall
                        )),
                      this.individualAnalyticsRules[t]);
                }),
                Object.defineProperty(t, "RESOURCEPATH", {
                  get: function () {
                    return "/analytics";
              ...
              return (
                                ...
                                switch (o.label) {
                                  ...
                                  case 1:
                                    return (
                                      ...
                                      !0 !== w &&
                                        (b.timeout =
                                          1e3 * h.connectionTimeoutSeconds),
                                      f &&
                                        0 !== Object.keys(f).length &&
                                        (b.params = f),
                                      h.sendApiKeyAsQueryParam &&
                                        ((b.params = b.params || {}),
                                      ...
                                      p &&
                                        ...
                                        (b.data = p),
                                      g &&
                                        ((_ = a.default.CancelToken),
                                        (P = _.source()),
                                        (v = function () {
                                          return P.cancel();
                                        }),
                                        g.addEventListener("abort", v),
                                        (b.cancelToken = P.token)),
                                      [4, (0, a.default)(b)]
                                    );
                                  case 2:
                                    if (
                                    ...
                                    throw h.customErrorForResponse(
                                      S,
                                    ...
                                    return (
                                      ...
                                      h.logger.warn(
                                        "Request #"
                                          ...
                                          .concat(
                                            h.retryIntervalSeconds,
                                            "s and then retrying request..."
                                          )
                                      ),
                                      [4, h.timer(h.retryIntervalSeconds)]
                                    );
                                  case 4:
                                    return o.sent(), [3, 6];
                                  case 5:
                ...
                (t.prototype.getNextNode = function (t) {
                      ...
                      this.nodes
                        .map(function (t) {
                          return "Node "
                            .concat(t.index, " is ")
                            .concat(
                              !0 === t.isHealthy ? "Healthy" : "Unhealthy"
                            );
                        })
                        .join(" || ")
                    )
                  ...
                  for (
                    ...
                    if (
                      ...
                      !0 ===
                        (e = this.nodes[this.currentNodeIndex]).isHealthy ||
                ...
                (t.prototype.initializeMetadataForNodes = function () {
                  ...
                  null != this.nearestNode &&
                    ...
                    this.setNodeHealthcheck(this.nearestNode, c)),
                    this.nodes.forEach(function (e, n) {
                      (e.index = n), t.setNodeHealthcheck(e, c);
                    });
                }),
                ...
                (t.prototype.customErrorForResponse = function (t, e) {
                  ...
                  var r = new u.default(n);
                  return (
                    ((r =
                      400 === t.status
                        ? new s.RequestMalformed(n)
                        : 401 === t.status
                        ? new s.RequestUnauthorized(n)
                        : 404 === t.status
                        ? new s.ObjectNotFound(n)
                        : 409 === t.status
                        ? new s.ObjectAlreadyExists(n)
                        : 422 === t.status
                        ? new s.ObjectUnprocessable(n)
                        : t.status >= 500 && t.status <= 599
                        ? new s.ServerError(n)
                        : new s.HTTPError(n)).httpStatus = t.status),
                    r
                  );
                }),
                t
            ...
            _ = (function () {
              function t(t) {
                ...
                (t.sendApiKeyAsQueryParam =
                  ...
                  (this.debug = new h.default(this.apiCall)),
                  (this.metrics = new p.default(this.apiCall)),
                  (this.health = new d.default(this.apiCall)),
                  (this.operations = new y.default(this.apiCall)),
                  (this.multiSearch = new v.default(
                    this.apiCall,
                    this.configuration
                  )),
                  (this._collections = new a.default(this.apiCall)),
                  (this.individualCollections = {}),
                  (this._aliases = new u.default(this.apiCall)),
                  (this.individualAliases = {}),
                  (this._keys = new l.default(this.apiCall)),
                  (this.individualKeys = {}),
                  (this._presets = new g.default(this.apiCall)),
                  (this.individualPresets = {}),
                  (this.analytics = new m.default(this.apiCall));
              }
              return (
                (t.prototype.collections = function (t) {
                  return void 0 === t
                    ...
                    : (void 0 === this.individualCollections[t] &&
                        (this.individualCollections[t] = new s.default(
                          t,
                          this.apiCall,
                          this.configuration
                        )),
                ...
                (t.prototype.aliases = function (t) {
                  return void 0 === t
                    ...
                    : (void 0 === this.individualAliases[t] &&
                        (this.individualAliases[t] = new c.default(
                          t,
                          this.apiCall
                        )),
                ...
                (t.prototype.keys = function (t) {
                  return void 0 === t
                    ...
                    : (void 0 === this.individualKeys[t] &&
                        (this.individualKeys[t] = new f.default(
                          t,
                          this.apiCall
                        )),
            ...
            d = (function () {
              function t(t, e, n) {
                (this.name = t),
                  ...
                  (this.apiCall = e),
                  (this.configuration = n),
                  (this._documents = new s.default(
                    this.name,
                    this.apiCall,
                    this.configuration
                  )),
                  (this._overrides = new c.default(this.name, this.apiCall)),
                    ...
                    return o(this, function (e) {
                      switch (e.label) {
                        ...
                        case 1:
                          return e.sent(), [2, !0];
                        case 2:
                          if ((t = e.sent()) instanceof u.ObjectNotFound)
                            return [2, !1];
                          throw t;
                        case 3:
                          return [2];
                ...
                (t.prototype.documents = function (t) {
                  return t
                    ? (void 0 === this.individualDocuments[t] &&
                        (this.individualDocuments[t] = new p.Document(
                          this.name,
                          t,
                          this.apiCall
                        )),
                ...
                (t.prototype.overrides = function (t) {
                  return void 0 === t
                    ...
                    : (void 0 === this.individualOverrides[t] &&
                        (this.individualOverrides[t] = new l.default(
                          this.name,
                          t,
                          this.apiCall
                        )),
                ...
                (t.prototype.synonyms = function (t) {
                  return void 0 === t
                    ...
                    : (void 0 === this.individualSynonyms[t] &&
                        (this.individualSynonyms[t] = new h.default(
                          this.name,
                          t,
                          this.apiCall
                        )),
              ...
              return (
                (t.prototype.validate = function () {
                  if (
                    ...
                    throw new u.MissingConfigurationError(
                  ...
                  return (
                    ...
                    r(this, void 0, void 0, function () {
                      return o(this, function (n) {
                        return [
                          2,
                          this.apiCall.patch(this.endpointPath(), t, e),
                        ];
                      });
                    })
                  );
                  ...
                  return (
                    ...
                    i(this, void 0, void 0, function () {
                      return a(this, function (n) {
                        ...
                        return [
                          2,
                          this.apiCall.post(this.endpointPath(), t, e),
                        ];
                      });
                    })
                  );
        ...
        4492: function (t, e) {
          ...
          var o = (function (t) {
            function e(e) {
              ...
              return (
                (r.name = n.name), Object.setPrototypeOf(r, n.prototype), r
              );
            }
            return r(e, t), e;
          })(Error);
        ...
        6718: function (t, e, n) {
          ...
          var a = r(n(4105));
          e.ObjectAlreadyExists = a.default;
          var s = r(n(3836));
          e.ObjectNotFound = s.default;
          var u = r(n(220));
          e.ObjectUnprocessable = u.default;
          var c = r(n(4913));
          e.RequestMalformed = c.default;
          var l = r(n(9976));
          e.RequestUnauthorized = l.default;
          var f = r(n(4959));
          e.ServerError = f.default;
          var h = r(n(9229));
          e.ImportError = h.default;
          var p = r(n(4492));
          e.TypesenseError = p.default;
        },
        1930: function (t, e) {
          "use strict";
          var n =
          ...
          var a = i(n(2708)),
            s = (function () {
              ...
              return (
                ...
                (t.prototype.endpointPath = function () {
                  return "".concat(a.default.RESOURCEPATH, "/").concat(this.id);
                }),
                t
              );
            })();
            ...
            s = (function () {
              function t(t, e, n) {
                void 0 === n && (n = !1),
                  ...
                  (this.requestWithCache = new a.default());
              }
              return (
        ...
        2598: function (t, e) {
          ...
          var i = (function () {
            ...
            return (
              ...
              (t.prototype.perform = function (t, e, i, a) {
                return n(this, void 0, void 0, function () {
                  var n, s, u, c, l, f, h, p, d, y, v;
                  return r(this, function (r) {
                    switch (r.label) {
                      case 0:
                        if (
                          ((n = a.cacheResponseForSeconds),
                          (s = void 0 === n ? 120 : n),
                          (u = a.maxSize),
                          (c = void 0 === u ? 100 : u),
                          s <= 0 || c <= 0)
                        ...
                        if (
                          ((l = JSON.stringify(i)),
                          (f = this.responseCache.get(l)),
                          (h = Date.now()),
                          f)
                        ) {
                          if (h - f.requestTimestamp < 1e3 * s)
                            return (
                              this.responseCache.delete(l),
                              this.responseCache.set(l, f),
                              [2, Promise.resolve(f.response)]
                            );
                          this.responseCache.delete(l);
                        }
                        if ((p = this.responsePromiseCache.get(l))) {
                          if (h - p.requestTimestamp < 1e3 * s)
                            return (
                              this.responsePromiseCache.delete(l),
                              this.responsePromiseCache.set(l, p),
                              [2, p.responsePromise]
                            );
                          this.responsePromiseCache.delete(l);
                        }
                        return (
                          (d = e.call.apply(e, o([t], i, !1))),
                          this.responsePromiseCache.set(l, {
                            requestTimestamp: h,
                            responsePromise: d,
                          }),
                          [4, d]
                      ...
                      case 1:
                        return (
                          (y = r.sent()),
                          this.responseCache.set(l, {
                            requestTimestamp: h,
                            response: y,
                          }),
                          this.responseCache.size > c &&
                            ((v = this.responseCache.keys().next().value),
                            this.responseCache.delete(v)),
                          this.responsePromiseCache.size > c &&
                            ((v = this.responsePromiseCache
                              .keys()
                              .next().value),
                            this.responsePromiseCache.delete(v)),
                          [2, y]
                        );
                    }
                  });
            ...
            u = (function () {
              function t(t) {
                ...
                (t.sendApiKeyAsQueryParam =
                  ...
                  (this.configuration = new o.default(t)),
                  (this.apiCall = new i.default(this.configuration)),
                  (this.multiSearch = new a.default(
                    this.apiCall,
                    this.configuration,
                    !0
                  )),
              ...
              return (
                (t.prototype.clearCache = function () {
                  this.multiSearch.clearCache(),
                    Object.entries(this.individualCollections).forEach(
                      function (t) {
    ...
    return (
      (() => {
            ...
            function t() {
              ...
              o(this, t),
                ...
                (this.server.cacheSearchResultsForSeconds =
                  null !== (e = this.server.cacheSearchResultsForSeconds) &&
                  void 0 !== e
                    ? e
                    : 120),
                (this.additionalSearchParameters =
                  null !== (n = w.additionalSearchParameters) && void 0 !== n
                    ? n
                    : {}),
                (this.additionalSearchParameters.query_by =
                  null !==
                    (r =
                      null !== (i = this.additionalSearchParameters.queryBy) &&
                      void 0 !== i
                        ? i
                        : this.additionalSearchParameters.query_by) &&
                  void 0 !== r
                ...
                (this.additionalSearchParameters.preset =
                  null !==
                    (a =
                      null !== (s = this.additionalSearchParameters.preset) &&
                      void 0 !== s
                        ? s
                        : this.additionalSearchParameters.preset) &&
                  void 0 !== a
                ...
                (this.additionalSearchParameters.sort_by =
                  null !==
                    (u =
                      null !== (c = this.additionalSearchParameters.sortBy) &&
                      void 0 !== c
                        ? c
                        : this.additionalSearchParameters.sort_by) &&
                  void 0 !== u
                  ...
                  null !==
                    (l =
                      null !==
                        (f =
                          this.additionalSearchParameters
                            .highlightFullFields) && void 0 !== f
                        ? f
                        : this.additionalSearchParameters
                            .highlight_full_fields) && void 0 !== l
                    ? l
                    : this.additionalSearchParameters.query_by),
                (this.geoLocationField =
                  null !== (h = w.geoLocationField) && void 0 !== h
                    ? h
                    : "_geoloc"),
                (this.facetableFieldsWithSpecialCharacters =
                  null !== (p = w.facetableFieldsWithSpecialCharacters) &&
                  void 0 !== p
                    ? p
                    : []),
                (this.collectionSpecificSearchParameters =
                  null !== (d = w.collectionSpecificSearchParameters) &&
                  void 0 !== d
                    ? d
                    : {}),
                Object.keys(this.collectionSpecificSearchParameters).forEach(
                  function (t) {
                    var e,
                      ...
                      i,
                      a,
                      s = _.collectionSpecificSearchParameters[t];
                    (s.query_by =
                      null !== (e = s.queryBy) && void 0 !== e
                        ? e
                        : s.query_by),
                      (s.preset =
                        null !== (n = s.preset) && void 0 !== n ? n : s.preset),
                      (s.sort_by =
                        null !== (r = s.sortBy) && void 0 !== r
                          ? r
                          : s.sort_by),
                      (s.highlight_full_fields =
                        null !==
                          (o =
                            null !==
                              (i =
                                null !== (a = s.highlightFullFields) &&
                                void 0 !== a
                                  ? a
                                  : s.highlight_full_fields) && void 0 !== i
                              ? i
                              : _.additionalSearchParameters
                                  .highlight_full_fields) && void 0 !== o
                          ? o
                          : s.query_by),
                      Object.keys(s).forEach(function (t) {
                        return void 0 === s[t] ? delete s[t] : {};
                      });
                  }
                ),
                (this.renderingContent = w.renderingContent),
                (this.flattenGroupedHits =
                  null === (y = w.flattenGroupedHits) || void 0 === y || y),
                (this.facetByOptions =
                  null !== (v = w.facetByOptions) && void 0 !== v ? v : {}),
                (this.filterByOptions =
                  null !== (g = w.filterByOptions) && void 0 !== g ? g : {}),
                (this.collectionSpecificFacetByOptions =
                  null !== (b = w.collectionSpecificFacetByOptions) &&
                  void 0 !== b
                    ? b
                    : {}),
                (this.collectionSpecificFilterByOptions =
                  null !== (m = w.collectionSpecificFilterByOptions) &&
                  void 0 !== m
                    ? m
                    : {});
            }
              ...
              u(t, [
                {
                  ...
                  value: function () {
                    if (
                      ...
                      0 === this.additionalSearchParameters.query_by.length &&
                        0 === this.additionalSearchParameters.preset.length &&
                        (0 ===
                          Object.keys(this.collectionSpecificSearchParameters)
                            .length ||
                          Object.values(
                            this.collectionSpecificSearchParameters
                          ).some(function (t) {
        ...
        var v = (function () {
          function t(e, n, r) {
            o(this, t),
              (this.instantsearchRequests = e),
              (this.typesenseClient = n),
              (this.configuration = r),
              (this.additionalSearchParameters = r.additionalSearchParameters),
              (this.collectionSpecificSearchParameters =
                r.collectionSpecificSearchParameters);
          }
          var n;
          return (
            u(
              ...
              [
                    ...
                    return (
                      !1 !==
                        ...
                        void 0 === n
                          ...
                          : n.exactMatch) &&
                      !1 !==
                        (null === (r = this.configuration.filterByOptions) ||
                        void 0 === r ||
                        null === (r = r[t]) ||
                        void 0 === r
                          ? void 0
                    ...
                    return t
                      ? (r = t
                          .map(function (t) {
                            if (Array.isArray(t)) {
                              ...
                              t.forEach(function (t) {
                                ...
                                Object.keys(r).length > 1 &&
                                  console.error(
                                    "[Typesense-Instantsearch-Adapter] Typesense does not support cross-field ORs at the moment. The adapter could not OR values between these fields: ".concat(
                                      Object.keys(r).join(",")
                                    )
                                  );
                              var o = Object.keys(r)[0],
                                i = r[o].reduce(
                                  function (t, e) {
                                    return (
                                      e.startsWith("-") && !n._isNumber(e)
                                        ? t[0].push(e.substring(1))
                                        : t[1].push(e),
                                      t
                                    );
                                  },
                                ...
                                c = [];
                              if (u.length > 0) {
                                var l = n._shouldUseExactMatchForField(o, e)
                                  ? ":="
                                  : ":";
                                c.push(
                                  ""
                              ...
                              if (s.length > 0) {
                                var f = n._shouldUseExactMatchForField(o, e)
                                  ? ":!="
                                  : ":!";
                                c.push(
                                  ""
                            ...
                            var h,
                              p = n._parseFacetFilter(t),
                              d = p.fieldName,
                              v = p.fieldValue;
                            if (v.startsWith("-") && !n._isNumber(v)) {
                              var g = n._shouldUseExactMatchForField(d, e)
                                ? ":!="
                                : ":!";
                              h = ""
                                .concat(d)
                                .concat(g, "[")
                                .concat(
                                  n._escapeFacetValue(v.substring(1)),
                                  "]"
                                );
                            } else {
                              var b = n._shouldUseExactMatchForField(d, e)
                                ? ":="
                                : ":";
                              h = ""
                                .concat(d)
                                .concat(b, "[")
                                .concat(n._escapeFacetValue(v), "]");
                            }
                            return h;
                          })
                          .join(" && "))
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (
                      ...
                      if (
                        ((n = new RegExp("^(".concat(a.join("|"), "):(.*)$"))),
                        null != (r = t.match(n)))
                      )
                        return {
                          fieldName: (o = "".concat(r[1])),
                          fieldValue: (i = "".concat(r[2])),
                        };
                    }
                    return (
                      (n =
                        this.constructor
                          .DEFAULT_FACET_FILTER_STRING_MATCHING_REGEX),
                      null == (r = t.match(n))
                        ? console.error(
                            "[Typesense-Instantsearch-Adapter] Parsing failed for a facet filter `"
                              .concat(t, "` with the Regex `")
                              .concat(
                                n,
                                "`. If you have field names with special characters, be sure to add them to a parameter called `facetableFieldsWithSpecialCharacters` when instantiating the adapter."
                              )
                          )
                        : ((o = "".concat(r[1]).concat(r[2])),
                          (i = "".concat(r[3]))),
                      { fieldName: o, fieldValue: i }
                    );
                  },
                },
                {
                ...
                },
                {
                  key: "_isNumber",
                  value: function (t) {
                    return Number.isInteger(t % 1) || !!(t % 1);
                  },
                },
                {
                    ...
                    return (
                      Object.keys(r).forEach(function (t) {
                        null != r[t]["<="] && null != r[t][">="]
                          ...
                          ? o.push("".concat(t, ":=").concat(r[t]["="]))
                          : console.warn(
                              "[Typesense-Instantsearch-Adapter] Unsupported operator found ".concat(
                                JSON.stringify(r[t])
                              )
                            );
                      }),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (
                      ...
                      var s =
                        this.configuration.facetableFieldsWithSpecialCharacters.map(
                          function (t) {
                            return t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
                          }
                        );
                    ...
                    if (
                      ((n =
                        this.constructor
                          .DEFAULT_NUMERIC_FILTER_STRING_MATCHING_REGEX),
                      null == (r = t.match(n)))
                    )
                      console.error(
                        "[Typesense-Instantsearch-Adapter] Parsing failed for a numeric filter `"
                          .concat(t, "` with the Regex `")
                          .concat(
                            n,
                            "`. If you have field names with special characters, be sure to add them to a parameter called `facetableFieldsWithSpecialCharacters` when instantiating the adapter."
                    ...
                    return { fieldName: o, operator: i, fieldValue: a };
                  },
                },
                {
                  key: "_adaptGeoFilter",
                  value: function (t) {
                    var e = t.insideBoundingBox,
                      n = t.aroundRadius,
                      r = t.aroundLatLng,
                      o = t.insidePolygon;
                    if (e) {
                      ...
                      if (Array.isArray(e)) {
                        var c = y(e.flat(), 4);
                        (i = c[0]), (a = c[1]), (s = c[2]), (u = c[3]);
                      } else {
                        var l = y(e.split(","), 4);
                        (i = l[0]), (a = l[1]), (s = l[2]), (u = l[3]);
                      }
                      return ""
                        .concat(this.configuration.geoLocationField, ":(")
                        .concat(i, ", ")
                        .concat(a, ", ")
                        .concat(i, ", ")
                        .concat(u, ", ")
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    var n = [];
                    return (
                      t.filters && n.push(t.filters),
                      n.push(this._adaptFacetFilters(t.facetFilters, e)),
                      n.push(this._adaptNumericFilters(t.numericFilters)),
                      n.push(this._adaptGeoFilter(t)),
                      n
                        .filter(function (t) {
                          return t && "" !== t;
                        })
                ...
                },
                {
                  ...
                  value: function (t) {
                    return t.match(
                      this.constructor.INDEX_NAME_MATCHING_REGEX
                    )[1];
                  },
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    return [t]
                      ...
                      .map(function (t) {
                        ...
                        return null !==
                          (r =
                            n.configuration.collectionSpecificFacetByOptions) &&
                          void 0 !== r &&
                          null !== (r = r[e]) &&
                          void 0 !== r &&
                          r[t]
                          ? ""
                              ...
                              .concat(
                                n.configuration
                                  .collectionSpecificFacetByOptions[e][t]
                              )
                          : n.configuration.facetByOptions[t]
                          ? ""
                              .concat(t)
                              .concat(n.configuration.facetByOptions[t])
                          : t;
                      })
                      .join(",");
                  },
                },
                {
                  ...
                  value: function (t) {
                    for (
                      var e = t.params,
                        n = t.indexName,
                        r = this._adaptIndexName(n),
                        o = {},
                        i = 0,
                        a = Object.entries(this.additionalSearchParameters);
                      i < a.length;
                      i++
                    ) {
                      var s = y(a[i], 2),
                        u = s[0],
                        c = s[1];
                      o[this._camelToSnakeCase(u)] = c;
                    }
                    if (this.collectionSpecificSearchParameters[r])
                      for (
                        var l = 0,
                          f = Object.entries(
                            this.collectionSpecificSearchParameters[r]
                          );
                        l < f.length;
                        l++
                      ) {
                        var h = y(f[l], 2),
                          p = h[0],
                          d = h[1];
                        o[this._camelToSnakeCase(p)] = d;
                      }
                    var v = Object.assign({}, o),
                      g = this._adaptSortBy(n);
                    return (
                      Object.assign(v, {
                        collection: r,
                        q: "" === e.query || void 0 === e.query ? "*" : e.query,
                        facet_by: o.facet_by || this._adaptFacetBy(e.facets, r),
                        filter_by: this._adaptFilters(e, r) || o.filter_by,
                        sort_by: g || o.sort_by,
                        max_facet_values: e.maxValuesPerFacet,
                        page: (e.page || 0) + 1,
                      }),
                      e.hitsPerPage && (v.per_page = e.hitsPerPage),
                      e.facetQuery &&
                        ((v.facet_query = ""
                          .concat(e.facetName, ":")
                          .concat(e.facetQuery)),
                        (v.per_page = 0)),
                      e.typesenseVectorQuery &&
                        (v.vector_query = e.typesenseVectorQuery),
                      Object.fromEntries(
                        Object.entries(v).filter(function (t) {
                          var e = y(t, 2),
                            n = (e[0], e[1]);
                          return null != n && "" !== n;
                        })
                          ...
                          function (t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                case 0:
                                  return (
                                    (e = this.instantsearchRequests.map(
                                      function (t) {
                                        return n._buildSearchParameters(t);
                                      }
                                    )),
                                    t.abrupt(
                                      "return",
                                      this.typesenseClient.multiSearch.perform({
                                        searches: e,
                                      })
                                    )
                                  );
        ...
        var m = {
          _adaptHighlightTag: function (t, e, n) {
            return t
              .replace(new RegExp("<mark>", "g"), e || "<mark>")
              .replace(new RegExp("</mark>", "g"), n || "</mark>");
          },
          _adaptNumberOfPages: function () {
            var t =
              this.typesenseResponse.found /
              this.typesenseResponse.request_params.per_page;
            return Number.isFinite(t) ? Math.ceil(t) : 1;
          },
        };
        function _(t, e) {
          var n = Object.keys(t);
          ...
          function t(e, n, r) {
            var i =
              arguments.length > 3 && void 0 !== arguments[3]
                ...
                : [];
            o(this, t),
              (this.typesenseResponse = e),
              (this.instantsearchRequest = n),
              (this.configuration = r),
              (this.allTypesenseResponses = i);
          }
          return (
            u(t, [
              {
                ...
                value: function (t) {
                  ...
                  return (
                    (n = t.map(function (t) {
                      var n = e._adaptHits(t.hits);
                      return (
                        n.forEach(function (e) {
                          (e.group_key = e._group_key = t.group_key),
                            t.found && (e._group_found = t.found);
                        }),
                        n
                      );
                    })),
                    this.configuration.flattenGroupedHits
                      ? n.flat()
                      : n.map(function (t) {
                          return w(w({}, t[0]), {}, { _grouped_hits: t });
                        })
                  );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  return t.map(function (t) {
                    var n = w({}, t.document);
                    (n.objectID = t.document.id),
                      (n._snippetResult = e._adaptHighlightResult(
                        t,
                        "snippet"
                      )),
                      (n._highlightResult = e._adaptHighlightResult(
                        t,
                        "value"
                      )),
                      (n._rawTypesenseHit = t),
                      [
                        "text_match",
                        "geo_distance_meters",
                        "curated",
                    ...
                    var r = n[e.configuration.geoLocationField];
                    return r && (n._geoloc = { lat: r[0], lng: r[1] }), n;
                  });
                },
              },
              {
                ...
                value: function (t, e) {
                  ...
                  return (
                    null != t.highlight &&
                    this.isHighlightPost0240RCN32Format(t.highlight)
                      ? this.adaptHighlightObject(t, n, e)
                      : this.adaptHighlightsArray(t, n, e),
                    n
                  );
                },
              },
              {
                ...
                value: function (t) {
                  return null == t.full && null == t.snippet;
                },
              },
              {
                ...
                value: function (t, e, n) {
                  ...
                  Object.assign.apply(
                    ...
                    [e].concat(
                      g(
                        Object.entries(t.document).map(function (t) {
                          var e = y(t, 2);
                          return b({}, e[0], {
                            value: e[1],
                            matchLevel: "none",
                    ...
                    t.highlights.forEach(function (t) {
                      (e[t.field] = {
                        value: t[n] || t["".concat(n, "s")],
                        matchLevel: "full",
                        matchedWords: t.matched_tokens,
                      }),
                        t.indices && (e[t.field].matchedIndices = t.indices);
                    }),
                    Object.entries(e).forEach(function (o) {
                      var a = y(o, 2),
                        ...
                        p = u.matchedIndices;
                      null == l
                        ? (e[c] = r._adaptHighlightNullValue())
                        : Array.isArray(l)
                        ? ((e[c] = []),
                          t.document[c].forEach(function (t, o) {
                            p && p.includes(o)
                              ? e[c].push({
                                  value: r._adaptHighlightTag(
                                    "".concat(l[p.indexOf(o)]),
                                    r.instantsearchRequest.params
                                      .highlightPreTag,
                                    r.instantsearchRequest.params
                                      .highlightPostTag
                                  ),
                              ...
                              : "object" === i(t)
                              ? e[c].push(
                                  r._adaptHighlightInObjectValue(t, {}, n)
                                )
                              : e[c].push({
                                  value: "".concat(t),
                                  matchLevel: "none",
                        ...
                        : "object" === i(l)
                        ? (e[c] = r._adaptHighlightInObjectValue(l, {}, n))
                        : (e[c].value = r._adaptHighlightTag(
                            "".concat(l),
                            r.instantsearchRequest.params.highlightPreTag,
                            r.instantsearchRequest.params.highlightPostTag
                          ));
                    });
                },
              },
              {
                ...
                value: function (t, e, n) {
                  Object.assign(
                    e,
                    this._adaptHighlightInObjectValue(
                      t.document,
                      t.highlight,
                      n
                    )
                      ...
                      g(
                        Object.entries(t).map(function (t) {
                          var o,
                            ...
                            s = a[0],
                            u = a[1];
                          if (null == u) o = r._adaptHighlightNullValue();
                          else if (Array.isArray(u)) {
                            var c;
                            o = r._adaptHighlightInArrayValue(
                              u,
                              null !== (c = null == e ? void 0 : e[s]) &&
                                void 0 !== c
                                ? c
                                : [],
                              n
                            ...
                            var l;
                            o = r._adaptHighlightInObjectValue(
                              u,
                              null !== (l = null == e ? void 0 : e[s]) &&
                                void 0 !== l
                                ? l
                                : {},
                              n
                            ...
                            o = r._adaptHighlightInPrimitiveValue(
                              u,
                              null == e ? void 0 : e[s],
                              n
                            );
              ...
              },
              {
                ...
                value: function (t, e, n) {
                  ...
                  return t.map(function (t, o) {
                    var a;
                    if (null == t) a = r._adaptHighlightNullValue();
                    else if (Array.isArray(t)) {
                      var s;
                      a = r._adaptHighlightInArrayValue(
                        t,
                        null !== (s = null == e ? void 0 : e[o]) && void 0 !== s
                          ? s
                          : [],
                        n
                      );
                      ...
                      var u;
                      a = r._adaptHighlightInObjectValue(
                        t,
                        null !== (u = null == e ? void 0 : e[o]) && void 0 !== u
                          ? u
                          : {},
                        n
                      );
                    } else
                      a = r._adaptHighlightInPrimitiveValue(
                        t,
                        null == e ? void 0 : e[o],
                        n
                      );
                ...
                value: function (t, e, n) {
                  ...
                  return null != e
                    ? {
                        ...
                        matchLevel:
                          (e.matched_tokens || []).length > 0 ? "full" : "none",
                        matchedWords: e.matched_tokens || [],
                      }
                    : {
                        value: this._adaptHighlightTag(
                          "".concat(t),
                      ...
                      Object.assign(
                        ...
                        b(
                          ...
                          Object.assign.apply(
                            ...
                            [{}].concat(
                              g(
                                t.counts.map(function (t) {
                                  return b({}, t.value, t.count);
                                })
                              )
                            )
                          )
                  ...
                  return (
                    t.forEach(function (t) {
                      Object.keys(t.stats).length > 0 &&
                        Object.assign(e, b({}, t.field_name, t.stats));
                    }),
                    e
                  );
                },
              },
              {
                ...
                value: function (t) {
                  var e,
                    n = Object.assign({}, this.configuration.renderingContent);
                  return (
                    null ==
                      (null === (e = n.facetOrdering) ||
                      void 0 === e ||
                      null === (e = e.facets) ||
                      void 0 === e
                        ? void 0
                        : e.order) &&
                      ((n.facetOrdering = n.facetOrdering || {}),
                      (n.facetOrdering.facets = n.facetOrdering.facets || {}),
                      (n.facetOrdering.facets.order = g(
                        new Set(
                          t
                            .map(function (t) {
                              return t.field_name;
              ...
              },
              {
                key: "adapt",
                value: function () {
                  var t = this._adaptRenderingContent(
                    this.typesenseResponse.facet_counts || []
                  );
                  return w(
                    {
                      hits: this.typesenseResponse.grouped_hits
                        ? this._adaptGroupedHits(
                            this.typesenseResponse.grouped_hits
                          )
                    ...
                    Object.keys(t).length > 0 ? { renderingContent: t } : null
                  );
                },
              },
            ]),
            ...
            u(t, [
              {
                ...
                value: function (t) {
                  ...
                  return t
                    .find(function (t) {
                      return (
                        t.field_name === e.instantsearchRequest.params.facetName
                      );
                    })
                    .counts.map(function (t) {
                      return {
                        value: t.value,
                        highlighted: e._adaptHighlightTag(
                          t.highlighted,
                          e.instantsearchRequest.params.highlightPreTag,
                          e.instantsearchRequest.params.highlightPostTag
                        ),
                        count: t.count,
                      };
                    });
              ...
              },
              {
                ...
                value: function () {
                  return {
                    facetHits: this._adaptFacetHits(
                      this.typesenseResponse.facet_counts
                    ),
          ...
          function t(e) {
            ...
            o(this, t),
              ...
              (this.searchClient = {
                ...
                search: function (t) {
                  return n.searchTypesenseAndAdapt(t);
                },
                searchForFacetValues: function (t) {
                  return n.searchTypesenseForFacetValuesAndAdapt(t);
                },
              });
          }
          var n, r, i;
          return (
            u(t, [
                            ...
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (
                                  (t.prev = 0),
                                  (t.next = 3),
                                  this._adaptAndPerformTypesenseRequest(e)
                                );
                              case 3:
                                return (
                                  (n = t.sent),
                                  (r = n.results.map(function (t, r) {
                                    return (
                                      o._validateTypesenseResult(t),
                                      new P(
                                        t,
                                        e[r],
                                        o.configuration,
                          ...
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 3:
                                return (
                                  (n = t.sent),
                                  (r = n.results.map(function (t, n) {
                                    return (
                                      o._validateTypesenseResult(t),
                                      new S(t, e[n], o.configuration).adapt()
                                    );
                                  })),
                                  t.abrupt("return", r)
                                );
              ...
              },
              {
                ...
                value: function () {
                  return (
                    (this.typesenseClient = new h.SearchClient(
              ...
              },
              {
                ...
                value: function (t) {
                  if (t.error)
                    throw new Error("".concat(t.code, " - ").concat(t.error));
                  if (!t.hits && !t.grouped_hits)
                    throw new Error(
