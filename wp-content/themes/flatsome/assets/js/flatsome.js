  ...
  (r.m = i),
    ...
    (function () {
      ...
      const e = document.body,
        ...
        n = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(
          navigator.userAgent
        );
      let o = 0;
      function i() {
      ...
      function g(e) {
        ...
        void 0 === c &&
          void 0 === u &&
          (d.hasClass("sticky-shrink")
            ? ((c = f.hasClass("hide-for-sticky") ? f.height() : 0),
              (c += p.hasClass("hide-for-sticky") ? p.height() : 0),
              (u = 1 + c))
            : ((c = h.height() + 100),
              (u = f.hasClass("hide-for-sticky") ? f.height() + 1 : 1))),
          m
            ? "down" === t || e < u
              ? e < u
                ? b()
                : ((l = setTimeout(b, 100)),
                  d.addClass("sticky-hide-on-scroll--active"))
              : e > c &&
                ((l = setTimeout(() => v(n), 100)),
                d.removeClass("sticky-hide-on-scroll--active"))
            : e > c
            ? v(n)
            : e < u && b();
      }
      function v() {
        ...
        jQuery(document).trigger("flatsome-header-sticky"),
          h.addClass("stuck"),
          h.toggleClass("ux-no-animation", e),
          d.height(t),
      ...
      function b() {
        h.hasClass("stuck") &&
          (d.height(""),
          h.removeClass(["stuck", "ux-no-animation"]),
      ...
      y &&
        (document.addEventListener("DOMContentLoaded", () => {
          s((n, o) => {
            let { scrollY: i, direction: a } = o;
            l && (clearTimeout(l), (l = void 0)),
              e.classList.contains(t) || g(i, a);
          }),
            (l = setTimeout(() => {
        ...
        jQuery("body").on("experimental-flatsome-pjax-request-done", () => {
          (d = jQuery("#header")),
            ...
            (y = d.hasClass("has-sticky")),
            (m = d.hasClass("sticky-hide-on-scroll")),
            window.scrollY && g(window.scrollY, void 0, !0);
        }));
        ...
        Q.length &&
          ...
          (x = requestAnimationFrame(() => {
            for (let e = 0; e < Q.length; e++)
              Q[e].element.offsetParent ? E(Q[e]) : Q.splice(e, 1);
          })));
      }
      function E(e) {
        !(function (e) {
          let { element: t, type: n } = e,
            o = I(t.dataset.parallax),
            i = P(t),
          ...
          (function (e) {
            let { element: t, type: n } = e,
              o = I(t.dataset.parallax || t.dataset.parallaxBackground),
                ...
                case "backgroundImage":
                  (p = l.top * o),
                    (t.style.backgroundPosition = o
                      ? `50% ${p.toFixed(0)}px`
                      : null),
                    (t.style.backgroundAttachment = o ? "fixed" : null);
                  break;
                case "backgroundElement":
                  (p = d * o - r / 2),
                    (t.style.transform = o
                      ? `translate3d(0, ${p.toFixed(2)}px, 0)`
                      : null),
                    (t.style.backfaceVisibility = o ? "hidden" : null);
                  break;
                case "element":
                  (p = h * o),
                    (t.style.transform = o
      ...
      window.addEventListener("scroll", C, { passive: !0 }),
        ...
        new MutationObserver(C).observe(document.body, { childList: !0 }),
        window.jQuery &&
        ...
        r(8417),
        jQuery.fn.flickity ||
          ((O.isFlickityStub = !0), (jQuery.fn.flickity = O)),
        ...
        if (e.intersectionRatio > 0) {
          ...
          r.e(408)
            ...
            .then((e) => {
              ...
              new n(t.get(0), o, { decimalPlaces: 0, duration: 4 }).start(),
                t.addClass("active");
            });
        }
      });
                    ...
                    callbacks: {
                      ...
                      afterClose: function () {
                        jQuery("html").removeClass("has-off-canvas-" + r),
                          ...
                          s && jQuery(e).removeClass("mfp-hide");
                      },
                    },
                  });
              });
      ...
      const V = F((e) => {
        e.intersectionRatio > 0 &&
          (V.unobserve(e.target), jQuery(e.target).addClass("bg-loaded"));
      });
                    ...
                    (function (e) {
                      ...
                      const d = function () {
                          ...
                          const o = window.scrollY + n - Math.round(a?.top),
                            ...
                            d = Math.max(
                              Math.min(s, Math.round(a?.height - r?.height)),
                              0
                            );
                          let h = null,
                            f = null;
                          !a || r?.height < i - n
                            ...
                            ? o <= l
                              ? (h = d)
                              : r?.height - o <= i &&
                                ((f = i - Math.round(r?.height)), (l = o))
                            : "up" === t &&
                              (o <= s
                                ? ((f = n),
                                  (l = o + Math.round(r?.height) - i + n))
                                : (h = d)),
                            (h === c && f === u) ||
                              ((e.style.top =
            ...
            const n = F((e) => {
              e.isIntersecting &&
                ...
                (function (e) {
                  ...
                  Promise.all([
                    r.e(288).then(r.bind(r, 4600)),
                    r.e(288).then(r.bind(r, 5534)),
                  ]).then((e) => {
                    let [, { create: r }] = e;
                    t.load(n.src),
