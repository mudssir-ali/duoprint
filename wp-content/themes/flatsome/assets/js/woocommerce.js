              ...
              equalizeItems: function (t) {
                ...
                (e.maxHeight = 0),
                  ...
                  jQuery(t, e.currentElement).each(function (t) {
                    ...
                    e.$items.push(o),
                      o.height(""),
                      o.children(".js-star-rating").remove();
              ...
              maybeAddDummySwatches: function (t) {
                ...
                this.swatches.present &&
                  (e.children(".ux-swatches.ux-swatches-in-loop").length ||
                    ...
                    e
                      .children(".js-ux-swatches")
                      .height(this.swatches.height)));
              },
              getScreenSize: function () {
                return window.matchMedia("(min-width: 850px)").matches
                  ? this.ScreenSize.LARGE
                  : window.matchMedia(
                      "(min-width: 550px) and (max-width: 849px)"
                    ).matches
              ...
              init: function () {
                ...
                jQuery(".equalize-box", t).each((t, i) => {
                  (e.currentElement = i),
                    ...
                    1 !== e.colPerRow &&
                      ((e.disablePerRow =
                        jQuery(i).hasClass("row-slider") ||
                        jQuery(i).hasClass("row-grid")),
                      (e.boxCount = jQuery(
                        ".box-text",
                        e.currentElement
                      ).length),
      ...
      6619: function () {
        Flatsome.plugin("addQty", function (t, e) {
          ...
          String.prototype.uxGetDecimals ||
            ...
            o
              .off("click.flatsome", ".plus, .minus")
              .on("click.flatsome", ".plus, .minus", function () {
                const t = jQuery(this),
                ...
                (o && "" !== o && "NaN" !== o) || (o = 0),
                  ...
                  t.is(".plus")
                    ? i && (i === o || o > i)
                      ? e.val(i)
                      : e.val((o + parseFloat(n)).toFixed(n.uxGetDecimals()))
                    : r && (r === o || o < r)
                    ? e.val(r)
                    : o > 0 &&
                      e.val((o - parseFloat(n)).toFixed(n.uxGetDecimals())),
          ...
          (i = [o(9567)]),
            (r = function (t) {
              !(function (t) {
                ...
                function c(e, o) {
                  (this.$target = t(e)),
                    (this.opts = t.extend({}, s, o, this.$target.data())),
                  ...
                  (c.prototype._loadImage = function (e, o) {
                    ...
                    this.$target
                      ...
                      (this.$zoom = t(i)
                        ...
                        .on("load", o, t.proxy(this._onLoad, this))),
  ...
  (a.m = r),
    ...
    (function () {
      ...
      var e = function (e, o) {
          ...
          for (e && e(o); l < n.length; l++)
            (r = n[l]), a.o(t, r) && t[r] && t[r][0](), (t[r] = 0);
        },
    ...
    (function () {
      ...
      function i() {
        return jQuery.fn.magnificPopup
          ? Promise.resolve()
          : a.e(964).then(a.t.bind(a, 4343, 23));
      }
      o(),
              ...
              r.preventDefault(),
                i().then(() => {
                  e.data("magnificPopup") || e.magnificPopup(t),
                    e.magnificPopup("open", o.index(r.currentTarget) || 0);
                });
            }),
            e
          );
        ...
        a(4168);
      var r = !1;
      const n = /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(
        navigator.userAgent
      );
      function s() {
        ...
        if (jQuery(".cart-item .nav-dropdown").length)
          ...
          if (jQuery.fn.magnificPopup) {
            if (
              ...
              t &&
                "#cart-popup" === jQuery.magnificPopup.instance?.currItem?.src)
            )
              return;
      ...
      jQuery(document).on("flatsome-product-gallery-tools-init", () => {
        ...
        jQuery(function (t) {
          ...
          const c = t.Deferred(),
            l = t.Deferred();
          i.one("flatsome-flickity-ready", () => c.resolve()),
            a.one("flatsome-flickity-ready", () => l.resolve()),
            (a.length && !a.is(":hidden")) || l.resolve();
          const u = function () {
              r &&
                r.length &&
                ((s = r
                  .filter(".has-image-zoom .slide.first")
                  .data("easyZoom")),
                s.swap(
          ...
          const m = t.when(c, l).then(() => {
            n && h(),
              o.on("hide_variation", function (o, i) {
                t(
                  ".product-thumbnails .first img, .sticky-add-to-cart-img"
                ).attr("src", e),
                  h();
              }),
        ...
        jQuery(function (t) {
          ...
          const o = (function (t) {
            ...
            (o) => {
              const { top: i } = o.boundingClientRect,
                r = o.intersectionRatio <= 0 && i <= 0;
              e.toggleClass("sticky-add-to-cart--active", r),
                t("body").toggleClass("has-sticky-product-cart", r);
            },
            { threshold: 0 }
          );
          t(".sticky-add-to-cart-select-options-button", e).on(
            "click",
            function (e) {
              e.preventDefault(),
                t.scrollTo(".product form.variations_form", {
                  offset: -s() - 15,
                });
            }
          );
          ...
          t(`#product-${i} button.single_add_to_cart_button`)
            .first()
            .each((i, n) => {
        ...
        jQuery(function (t) {
          t("#login-form-popup").find(".woocommerce-notices-wrapper > ul")
            .length > 0 &&
            t('[data-open="#login-form-popup"]').trigger("click");
        });
    })();
})();
